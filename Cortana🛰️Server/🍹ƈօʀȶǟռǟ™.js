...
require(`./konfs`);
// ⎿(𝐜)𝐂𝐨𝐫𝐭𝐚𝐧𝐚: _kryozen${vers.vers}_⏋\n⎿𝐃𝐚𝐭𝐞: _${Clock}_⏋\n⎿𝐏𝐢𝐧𝐠: _${Ping}ms_⏋
const { MessageType, Mimetype } = require(`@adiwajshing/baileys`);
const Welcome = require(`../Cortana🍃Goose/setwelcome`);
const LinkList = require(`../Cortana🍃Goose/antilink`);
const Ranker = require(`../Cortana🍃Goose/autorank`);
const Cortana_Buttons = require(`./Cortana_Buttons`);
const BanPerson = require(`../Cortana🍃Goose/ban`);
const BanGroup = require(`../Cortana🍃Goose/ban`);
const Cortana_Static = require(`./Cortana_Static`);
const Cortana_Loca = require(`./Cortana_Loca`);
...
async function ƈօʀȶǟռǟ() {
  ...
  console.log(Kolor.yellow(`💡 𝐈𝐧𝐟𝐨⬰ Symlinking With Cortana System Files...`));
...
║💻 𝐆𝐢𝐭𝐡𝐮𝐛: _https://github.com/Krakinz/Cortana_
╚════════════╝`,
        MessageType.text
      )
