...
module.exports = {
  ...
  爪𝖎𝖟𝖚ӄ𝖎ʍօʀɛ: `Use  *${ᴋᴇɪ}tr <text> = <language>*  to translate text to the specified language. 
...
*${ᴋᴇɪ}tr <text> = <language>*`,
      ...
      if (!爪𝖎𝖟𝖚ӄ𝖎.isReply) {
        try {
          var body = 爪𝖎𝖟𝖚ӄ𝖎.body.split(`=`);
          text = body[0].replace(爪𝖎𝖟𝖚ӄ𝖎.body[0] + 爪𝖎𝖟𝖚ӄ𝖎.commandName + ` `, ``);
          var i = 0;
      ...
      } else if (爪𝖎𝖟𝖚ӄ𝖎.replyMessage) {
        text = 爪𝖎𝖟𝖚ӄ𝖎.replyMessage;
        language = arg[0];
      } else {
        await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
          .sendMessage(
