...
<br>│║✡ 🗓️𝐃𝐚𝐭𝐞: <I>${Today.getDate()}d : ${Today.getMonth() + 1}m : ${Today.getFullYear()}y</I>
...
<p style="font-size:1.5vw; color:#cec3a8"><b>🖊️Command:</b> <I>${νℓкуяє.budy || νℓкуяє.mtype}</I>
<p style="font-size:1.5vw; color:#cec3a8"><b>❣️User-Name:</b> <I>${νℓкуяє.pushname}</I>
<p style="font-size:1.5vw; color:#cec3a8"><b>📱User_Number:</b> <I>${νcнαт.sender}</I>
...
<p style="font-size:1.5vw; color:#cec3a8"><b>🗓️Date:</b> <I>${Today.getDate()}d : ${Today.getMonth() + 1}m : ${Today.getFullYear()}y</I>
