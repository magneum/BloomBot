...
console.log(ᴋᴏʟᴏʀ.black(ᴋᴏʟᴏʀ.bgWhite("🔥𝖀𝖘𝖊𝖉: "), ᴋᴏʟᴏʀ.bgGreen(ꜱᴇʀᴄ)));
console.log(ᴋᴏʟᴏʀ.black(ᴋᴏʟᴏʀ.bgWhite("🕰️𝐂𝐥𝐨𝐜𝐤: "), ᴋᴏʟᴏʀ.bgGreen(ᴄʟᴏᴄᴋ.seconds)));
}
}
);
}
