            ...
            Videos.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (Found.seconds > 1800) {
                        Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Audio less then 30mins!_
...
⏰𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧: ${Found.timestamp}`, Found.thumbnail);
                    ...
                    (0, fluent_ffmpeg_1.default)(stream)
                        ...
                        yield Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `𝐘𝐨𝐮𝐓𝐮𝐛𝐞⭕️𝐌𝐮𝐬𝐢𝐜
