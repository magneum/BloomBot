...
<hr style="height:1px;border-top:1px solid #cec3a8" />
<span class="inline-block h-1 w-10 rounded mt-8 mb-6"></span>
<h2 class="text-red-500 font-medium title-font tracking-wider text-sm">𝐌𝐚𝐝𝐞 𝐖𝐢𝐭𝐡❣️𝐁𝐲 𝐊𝐫𝐲𝐊𝐧𝐳</h2>
<p class="text-gray-400"><i>All Rights Reserved</i></p>
</div>
</div>
</section>
<!--
...
>
<span class="ml-3 text-xl hover:text-red-400">❝ Ⓒ𝐕𝐋𝐊𝐘𝐑𝐄™ <I>Powered By KryKnz</I> ❞</span>
</a>
<p
...
<h1 class="text-3xl font-medium title-font text-white mb-12 text-center">꧁❓𝐅𝐫𝐞𝐪𝐮𝐞𝐧𝐭𝐥𝐲 𝐀𝐬𝐤𝐞𝐝❓꧂
</h1>
...
<h2 class="font-medium title-font text-sm text-red-400 mb-1 tracking-wider"><b>∘ What is the
reason/topic
of
Vlkyre?</b></h2>
<p class="leading-relaxed"><I>: Vlkyre is an Advance Whatsapp
User-Bot. You
Can Use The Bot in your respective groups that will help you with
many
Advance Work Within Whatsapp
</I></p>
</div>
</div>
<div class="flex relative pb-12">
...
<div class="flex-grow pl-4">
<h2 class="font-medium title-font text-sm text-red-400  mb-1 tracking-wider"><b>∘ How Can I
Add Vlkyre To
My
Own Groups?</b></h2>
<p class="leading-relaxed"><I>: Send Your Group Chat Links To Any Admins of Vlkyre Official
and ask
...
To
Use Vlkyre?</b></h2>
<p class="leading-relaxed"><I>: Just Join Any Above Official Group and Type #verify.
</I></p>
</div>
</div>
<div class="flex relative pb-12">
...
<div class="flex-grow pl-4">
<h2 class="font-medium title-font text-sm text-red-400  mb-1 tracking-wider"><b>∘ I have
forked the repo
but
bot doesn't want to run.Help Me!</b>
<br>
</h2>
<p class="leading-relaxed"><I>: Read GitHub Repo and Forget Any Help From Our Side.
</I></p>
</div>
</div>
...
<div class="flex-grow pl-4">
<h2 class="font-medium title-font text-sm text-red-400  mb-1 tracking-wider"><b>∘ How Do I
Deploy or Get
My
Own Vlkyre userbot?</b></h2>
<p class="leading-relaxed"><I>: For Now Our Code Doesn't Allow Any User To Self host.
You May Try Yourself but no support from ourside!
</I></p>
</div>
</div>
</div>
<img class="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12"
src="https://i.postimg.cc/hjXBjsJg/Univ-B.png" alt="step">
</div>
</div>
</section>
<!--
...
<h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">꧁𝐂𝐚𝐭𝐞𝐠𝐨𝐫𝐢𝐞𝐬
𝐄𝐱𝐩𝐥𝐚𝐢𝐧𝐞𝐝꧂</h1>
<p class="mb-8 leading-relaxed">
<br>꧁◇════════════════════◇꧂</br>
</h2>
<b>
🧀𝐍𝐨 𝐑𝐞𝐬𝐭𝐫𝐢𝐜𝐭𝐢𝐨𝐧 / 𝐅𝐨𝐫 𝐄𝐯𝐞𝐫𝐲𝐨𝐧𝐞🧀
</b>
</h2>
<br>꧁◇════════════════════◇꧂</br>

<br><mark class="red"><b></b>🍙 #animemenu ⋗</b></mark> <I>search anime, get anime gifs,get random
anime wallpapers.</I>
<br><mark class="red"><b></b>💰 #gamemenu ⋗</b></mark> <I>play random games on whatsapp.</I>
<br><mark class="red"><b></b>⭕ #ytfiltermenu ⋗</b></mark> <I>download yt audio with filters
pre-applied.</I>
<br><mark class="red"><b></b>📥 #downloadmenu ⋗</b></mark> <I>download videos and audio files from
YouTube,Instagram.</I>
<br><mark class="red"><b></b>🔰 #groupmenu ⋗</b></mark> <I>group moderation and automation.</I>
<br><mark class="red"><b></b>🦄 #randommenu ⋗</b></mark> <I>some random stuffs look yourself.</I>
<br><mark class="red"><b></b>🔎 #searchmenu ⋗</b></mark> <I>surf the internet within whatsapp.</I>
<br><mark class="red"><b></b>🗂️ #ffmpegmenu ⋗</b></mark> <I>convertion using ffmpeg.</I>
<br><mark class="red"><b></b>🏝️ #filtersmenu ⋗</b></mark> <I>add custom audio filter to mp3
files.</I>
<br><mark class="red"><b></b>🎨 #checkmenu ⋗</b></mark> <I>tag or reply to someone to check what
category they are.</I>
<br></br>
<br></br>
<br>꧁◇════════════════════◇꧂</br>
...
<b>
⚜️𝐀𝐝𝐦𝐢𝐧 / 𝐎𝐰𝐧𝐞𝐫 / 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐎𝐧𝐥𝐲 ⚜️
</b>
</h2>
<br>꧁◇════════════════════◇꧂</br>
<br><mark class="red"><b></b>👑 #ownermenu ⋗</b></mark> <I>commands that can be used only by owners
and devs.</I>
<br><mark class="red"><b></b>🔰 #groupmenu ⋗</b></mark> <I>commands for group moderation.</I>
<br><mark class="red"><b></b>🍑 #hentaimenu ⋗</b></mark> <I>not safe for work hentai stuffs.</I>
<br><mark class="red"><b></b>🥃 #humanmenu ⋗</b></mark> <I>not safe for work adult stuffs.</I>
</p>
<div class="flex justify-center">
<button
onclick="window.location.href='https://heroku.com/deploy?template=https://github.com/KryKnz/Vlkyre/Vlkyre.git/tree/🛰️KryTek'"
class="inline-flex text-gray-900 bg-gray-200 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
🛰️ʜᴇʀᴏᴋᴜ
</button>
...
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">💰 #GAMEMENU 💰</h2>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🔎 #SEARCHMENU 🔎</h2>
<p class="leading-relaxed text-base mb-4">
<I>#ytsearch</I>
<I>#lyrics</I>
<I>#github</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">📥 #DOWNLOADMENU 📥</h2>
<p class="leading-relaxed text-base mb-4">
<I>#play</I>
<I>#watch</I>
<I>#soundcloud</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🗂️ #FFMPEGMENU 🗂️</h2>
<p class="leading-relaxed text-base mb-4">
<I>#tomp3</I>
<I>#img2url</I>
<I>#ocr</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">⭕ #YTFILTERMENU ⭕</h2>
<p class="leading-relaxed text-base mb-4">
<I>#yt8d</I>
<I>#ytbassboost</I>
<I>#ytecho</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🍰 #FILTERMENU 🍰</h2>
<p class="leading-relaxed text-base mb-4">
<I>#8d</I>
<I>#bassboost</I>
<I>#echo</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">👑 #OWNERMENU 👑</h2>
<p class="leading-relaxed text-base mb-4">
<I>#join</I>
<I>#dyno</I>
<I>#ban</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🍙 #ANIMEMENU 🍙</h2>
<p class="leading-relaxed text-base mb-4">
<I>#anime</I>
<I>#ranimewall</I>
<I>#smile</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🔰 #GROUPMENU 🔰</h2>
<p class="leading-relaxed text-base mb-4">
<I>#antilink</I>
<I>#autorank</I>
<I>#setwelcome</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🦄 #RANDOMMENU 🦄</h2>
<p class="leading-relaxed text-base mb-4">
<I>#rank</I>
<I>#leaderboard</I>
<I>#joke</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🎨 #CHECKMENU 🎨</h2>
<p class="leading-relaxed text-base mb-4">
<I>#gaycheck</I>
<I>#lesbocheck</I>
<I>#beautycheck</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🥃 #HUMANMENU 🥃</h2>
<p class="leading-relaxed text-base mb-4">
<I>#4k</I>
<I>#blowjob</I>
<I>#milf</I>
...
<div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
<h2 class="text-lg sm:text-xl text-red-600 font-medium title-font mb-2">🍑 #HENTAIMENU 🍑</h2>
<p class="leading-relaxed text-base mb-4">
<I>#ass</I>
<I>#bdsm</I>
<I>#cum</I>
...
<button onclick="window.location.href='https://github.com/KryKnz/Vlkyre'"
class="flex mx-auto mt-16 text-white bg-red-900 border-0 py-2 px-8 focus:outline-none hover:bg-gray-800 rounded text-lg">💡GitHub
</button>
</div>
</section>
<!--
