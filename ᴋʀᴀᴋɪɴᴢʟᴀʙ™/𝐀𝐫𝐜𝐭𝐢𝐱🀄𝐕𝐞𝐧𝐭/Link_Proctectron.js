...
("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
const Link_Proctectron = (client, Fox, AʀƈȶɨӼ, ӄʀʏȶɛӄ) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (AʀƈȶɨӼ.isGroup &&
            !AʀƈȶɨӼ.fromMe &&
            !AʀƈȶɨӼ.isSenderDev &&
            ...
            yield LinkList.findOne({
                ...
                if (isGroupLink && !isCurrentGroupLink && !AʀƈȶɨӼ.isCmd) {
                    yield Image_Button.VImg(client, Fox, AʀƈȶɨӼ, `╔◇═══════════════◇╗
┊ 𝐊𝐫𝐲𝐙𝐞𝐧❌𝐀𝐧𝐭𝐢-𝐋𝐢𝐧𝐤
┊    𝐌𝐞𝐜𝐡𝐚𝐧𝐢𝐬𝐦
╚◇═══════════════◇╝
...
🐾 Telegram Link`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ.png");
                ...
                else if (AʀƈȶɨӼ.body.includes("https://t.me/") &&
