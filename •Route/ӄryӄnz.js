...
let dbAuth = require("../•dBase/🍂𝖘𝖖𝖑/Auth");
let dbCloudAuth = require("../•dBase/🌩️𝖈𝖑𝖔𝖚𝖉𝖉𝖇/dbcloud");
let { smsg, getBuffer, getSizeMedia } = require(`../•Sandbox/ɴᴇᴄᴛᴏʀ`);
let {
imageToWebp,
videoToWebp,
writeExifImg,
writeExifVid,
} = require(`../•Sandbox/exif`);
...
let { writeExif } = require(`../•Sandbox/exif`);
...
format("woff2"),
url("https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/d?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3")
format("woff"),
url("https://use.typekit.net/af/00ac0a/00000000000000003b9b2033/27/a?primer=7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191&fvd=n7&v=3")
format("opentype");
font-style: normal;
font-weight: 700;
}
...
<body>
<section>Vlkyre By KryKenz</section>
</body>
</html>
`)
);
