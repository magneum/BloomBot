    ...
    handle(TUF, Fox, Vʟӄʏʀɛ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                const Invite = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupInviteCode(Vʟӄʏʀɛ.chatId);
...
🔗𝐋𝐢𝐧𝐤: https://chat.whatsapp.com/${Invite}`,
                    ...
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡𝐈𝐧𝐟𝐨: Group Invite Link Has Been Sent To Their DM!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else {
                    yield TUF.sendMessage(Vʟӄʏʀɛ.sender, {
                        quoted: Fox,
                        timestamp: Date(),
                        contextInfo: { mentionedJid: [Vʟӄʏʀɛ.sender] },
                        image: { url: 𝕻𝕻𝖑𝖊𝖙𝖊𝖗 },
...
https://chat.whatsapp.com/${Invite}`,
                    ...
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡𝐈𝐧𝐟𝐨: Group Invite Link Has Been Sent To Your DM!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                }
            }
            catch (error) {
