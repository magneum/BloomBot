                ...
                */
                if (Vʟӄʏʀɛ.isImage || Vʟӄʏʀɛ.isGIF || Vʟӄʏʀɛ.isVideo) {
                    var FileSocketObject = {
                        message: Vʟӄʏʀɛ.type === "image"
                            ? Fox.message.imageMessage
                            : Fox.message.videoMessage,
                        type: Vʟӄʏʀɛ.type,
                    };
                    var FileID = Fox.key.id;
                    yield ToSticker.VStk(TUF, Fox, ǟʀɢʊʍɛռȶ, Vʟӄʏʀɛ, FileID, FileSocketObject);
                    /*
                    ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                    「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                    ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                    ...
                    */
                    ...
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - reply to media: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}
