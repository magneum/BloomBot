...
*/
`|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|`;
const RankCheck_1 = __importDefault(require("./RankCheck"));
...
("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
const RankIT = (client, Fox, AʀƈȶɨӼ, ӄʀʏȶɛӄ) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield BanPerson.findOne({
            ID: AʀƈȶɨӼ.sender,
            ...
            BanGroup.findOne({
                ...
                if (AʀƈȶɨӼ.isGroup && !AʀƈȶɨӼ.fromMe && !BanGroup && !BanPerson) {
                    Ranker.findOne({
                        ...
                        if (!userRank)
                            return;
                        yield RankCheck_1.default.VRnc(client, ӄʀʏȶɛӄ, Fox, AʀƈȶɨӼ);
                    }));
                }
            }));
        }));
