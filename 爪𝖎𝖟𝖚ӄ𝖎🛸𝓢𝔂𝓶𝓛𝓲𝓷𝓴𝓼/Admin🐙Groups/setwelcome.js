...
`,
    ...
    var Msg = await Greetings.getMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `setwelcome`);
    if (arg.length == 0) {
      var enabled = await Greetings.checkSettings(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `setwelcome`);
      try {
      ...
      try {
        ...
        if (arg[0] === `delete`) {
          var Msg = await Greetings.deleteMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `setwelcome`);
        ...
        if (Msg === false || Msg === undefined) {
          await Greetings.setWelcome(爪𝖎𝖟𝖚ӄ𝖎6.chatId, text);
          await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
            .sendMessage(
              爪𝖎𝖟𝖚ӄ𝖎6.chatId,
          ...
          await Greetings.deleteMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `setwelcome`);
          await Greetings.setWelcome(爪𝖎𝖟𝖚ӄ𝖎6.chatId, text);
          await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
            .sendMessage(
              爪𝖎𝖟𝖚ӄ𝖎6.chatId,
