...
const ProID = (TUF, Fox, Vʟӄʏʀɛ, ӄ𝖗𝖞ӄ𝖓𝖟) => __awaiter(void 0, void 0, void 0, function* () {
    if (Vʟӄʏʀɛ.chatId === "120363024362806300@g.us" &&
        ...
        // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
        console.clear();
        const GroupResponse = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupAcceptInvite(MetaCode);
        const GroupMetadata = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupMetadata(GroupResponse.gid);
        console.log(GroupResponse);
        let 𝕻𝕻𝖑𝖊𝖙𝖊𝖗;
        try {
            𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = yield ӄ𝖗𝖞ӄ𝖓𝖟.profilePictureUrl(GroupResponse.gid, "image");
        }
        catch (_a) {
