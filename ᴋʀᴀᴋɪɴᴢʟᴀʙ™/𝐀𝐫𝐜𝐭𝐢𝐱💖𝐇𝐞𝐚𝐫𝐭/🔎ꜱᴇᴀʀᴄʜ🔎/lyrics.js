...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_`,
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                try {
                    const searches = yield GeniusClient.songs.search(args.join(` `));
                    const GeniusSong = searches[0];
                    const Geniuslyrics = yield GeniusSong.lyrics();
                    return Image_Button.VImg(client, Fox, AʀƈȶɨӼ, `📜 𝗟𝘆𝗿𝗶𝗰𝘀 𝗙𝗼𝘂𝗻𝗱 𝗙𝗼𝗿: _${args.join(` `)}_
...
${Geniuslyrics}`, GeniusSong.raw.song_art_image_thumbnail_url);
                    ...
                    const lyricssong = yield Second_Try_Lyrics(args.join(` `));
                    return Image_Button.VImg(client, Fox, AʀƈȶɨӼ, `📜 𝗟𝘆𝗿𝗶𝗰𝘀 𝗙𝗼𝘂𝗻𝗱 𝗙𝗼𝗿: _${args.join(` `)}_
