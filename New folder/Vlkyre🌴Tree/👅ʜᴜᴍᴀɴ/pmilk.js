...
("|⬡═══════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═══════════════════════════════════════════════════════════════⬡|");
await got("https://www.reddit.com/r/lactating/random.json").then(async (FF) => {
...
let ꜰɪɴᴀʟʟɪɴᴋ = await got("https://www.reddit.com/r/lactating/random.json").then(async (FF) => {
let ꜰɪʟᴇ = JSON.parse(FF.body);
let title = ꜰɪʟᴇ[0].data.children[0].data.title;
let ꜰɪɴᴀʟʟɪɴᴋ = ꜰɪʟᴇ[0].data.children[0].data.url;
