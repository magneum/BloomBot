...
// ╚════════════╝
("|⬡═══════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═══════════════════════════════════════════════════════════════⬡|");require("../Vlkyre🖋️Utilities/𝕷𝖆ყO𝖚𝖙");
let fs = require(`fs`);
...
exports.ARanks = async (Vlyre, 𝖍𝖆𝖜ӄ, Caught, A𝖗𝖌𝖘) => {
...
let 𝕯𝖎𝖘𝖕𝖑𝖆𝖞;
try {
𝕯𝖎𝖘𝖕𝖑𝖆𝖞 = await 𝖍𝖆𝖜ӄ.profilePictureUrl(Vlyre.chatID, `image`);
} catch {
...
if (Èrrðr) return Caught(𝖍𝖆𝖜ӄ, Vlyre, Èrrðr);
