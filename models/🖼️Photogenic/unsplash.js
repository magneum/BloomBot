...
*⚡Usage* 
<<<<<<< HEAD
> _${WhatsBot.prefix}${finalname} image-name_`
      );
    }
    ...
    WhatsBot
      .magfetch(
        WhatsBot,
        "https://magneum.vercel.app/api/unsplash?q=" + WhatsBot.args.join(" ")
=======
> _${voxbot.prefix}${finalname} image-name_`
      );
    }
    ...
    voxbot
      .magfetch(
        voxbot,
        "https://magneum.vercel.app/api/unsplash?q=" + voxbot.args.join(" ")
>>>>>>> 17f52fe472c04e519779246ebe3026ed85ef536a
      )
      .then(async (response) => {
