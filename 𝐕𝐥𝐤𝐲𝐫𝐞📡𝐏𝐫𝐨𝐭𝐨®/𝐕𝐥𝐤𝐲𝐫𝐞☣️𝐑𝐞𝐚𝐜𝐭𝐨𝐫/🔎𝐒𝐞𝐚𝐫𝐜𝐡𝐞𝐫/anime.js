            ...
            try {
                ...
                */
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _anime name_`, dotScrpt);
                }
                /*
                ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                ...
                */
                ...
                yield malScraper.getInfoFromName(name).then((data) => __awaiter(this, void 0, void 0, function* () {
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡 𝐓𝐢𝐭𝐥𝐞: *${data.title}*
