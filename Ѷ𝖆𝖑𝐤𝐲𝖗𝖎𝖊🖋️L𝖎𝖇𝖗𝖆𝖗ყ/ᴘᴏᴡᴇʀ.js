...
exports.ᴘᴏᴡᴇʀ = async (ᴋᴜɴᴀɪ, Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊) => {
  ...
  if (Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.groupMetadata.subject.includes("𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭") && Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.body.includes("https")) {
    ...
    let [_, MetaCode] = Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.body.match(linkRegex) || [];
    ...
    const respo = await ᴋᴜɴᴀɪ.groupAcceptInviteV4(MetaCode, Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.body);
    const response = await ᴋᴜɴᴀɪ.groupGetInviteInfo(MetaCode);
    console.log("Information: " + response);
    console.log("Joined to: " + respo);
    return;

let 𝕯𝖎𝖘𝖕𝖑𝖆𝖞;
try {
𝕯𝖎𝖘𝖕𝖑𝖆𝖞 = await ᴋᴜɴᴀɪ.profilePictureUrl(GroupResponse.gid, "image");
} catch {
