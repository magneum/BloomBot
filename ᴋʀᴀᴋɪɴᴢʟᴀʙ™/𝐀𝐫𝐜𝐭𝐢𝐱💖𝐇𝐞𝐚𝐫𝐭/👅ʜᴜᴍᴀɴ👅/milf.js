    ...
    handle(client, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄʀʏȶɛӄ) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                yield got(`https://www.reddit.com/r/milf/random.json`).then((newScpt) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!amazeme.endsWith(`.png`) &&
                        ...
                        var amazeme = yield got(`https://www.reddit.com/r/milf/random.json`).then((newScpt) => __awaiter(this, void 0, void 0, function* () {
                            var file = JSON.parse(newScpt.body);
                            var title = file[0].data.children[0].data.title;
                            var amazeme = file[0].data.children[0].data.url;
