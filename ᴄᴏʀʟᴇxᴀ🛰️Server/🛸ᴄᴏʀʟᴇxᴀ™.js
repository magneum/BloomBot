...
const LinkList = require(`../ᴄᴏʀʟᴇxᴀ🍃Goose/antilink`);
const Ranker = require(`../ᴄᴏʀʟᴇxᴀ🍃Goose/autorank`);
const ᴄᴏʀʟᴇxᴀ_Buttons = require(`./ᴄᴏʀʟᴇxᴀ_Buttons`);
const BanPerson = require(`../ᴄᴏʀʟᴇxᴀ🍃Goose/ban`);
const BanGroup = require(`../ᴄᴏʀʟᴇxᴀ🍃Goose/ban`);
const ᴄᴏʀʟᴇxᴀ_Static = require(`./ᴄᴏʀʟᴇxᴀ_Static`);
const ᴄᴏʀʟᴇxᴀ_Loca = require(`./ᴄᴏʀʟᴇxᴀ_Loca`);
const 𝖈𝖔𝖗𝖑𝖊𝖝𝖆ֆʏռօք = require(`./𝖈𝖔𝖗𝖑𝖊𝖝𝖆ᴢᴇɴ`);
const { Tǟɮʟɛɨȶ } = require(`../Tǟɮʟɛɨȶ`);
const moment = require(`moment-timezone`);
const RankCheck = require(`./RankCheck`);
const speed = require(`performance-now`);
const 𝖈𝖔𝖗𝖑𝖊𝖝𝖆goose = require("mongoose");
...
`|⬡════════════════════════════════════════════|   (𝐜)𝐂𝐨𝐫𝐥𝐞𝐱𝐚𝐀𝐈  🛸  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛   |═══════════════════════════════════════════⬡|`;
if (𝖈𝖔𝖗𝖑𝖊𝖝𝖆.isGroup && !𝖈𝖔𝖗𝖑𝖊𝖝𝖆.fromMe && !BanGroup && !BanPerson) {
Ranker.findOne(
{
...
!𝖈𝖔𝖗𝖑𝖊𝖝𝖆.body.includes(ᴋᴇɪ + "rules") &&
...
await ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇
.sendMessage(𝖈𝖔𝖗𝖑𝖊𝖝𝖆.chatId, `❌`, MessageType.text, {
contextInfo: { mentionedJid: [աɦօֆɛռȶɦǟȶ] },
})
.catch((Error) =>
ꜰᴜᴄᴋ.catch(Error, ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇, 𝖈𝖔𝖗𝖑𝖊𝖝𝖆, chat)
