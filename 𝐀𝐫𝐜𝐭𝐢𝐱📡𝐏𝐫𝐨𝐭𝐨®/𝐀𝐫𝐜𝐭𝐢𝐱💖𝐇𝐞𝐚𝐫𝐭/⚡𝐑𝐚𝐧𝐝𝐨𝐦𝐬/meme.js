    ...
    handle(TUF, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!json[0]) {
                    return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `😂𝐌𝐞𝐌𝐞: _Your Life Lmfao!_`, "https://i.postimg.cc/9Xkbbm7m/meme.png");
                    //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                }
                else {
                    const data = json[0].data.children[0].data;
                    return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `😂𝐌𝐞𝐌𝐞
