...
!Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.fromMe &&
Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.isCommand &&
Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.chatID === "120363024362806300@g.us"
) {
return await Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.reply(
`*❌𝕰𝖗𝖗𝖔𝖗:* No Commands Can Work In This Group.Just Send Your Group Link with 20+ members.`
);
}
let ɢʀᴏᴜᴘ_ʟɪɴᴋʀᴇɢᴇx = /chat.whatsapp.com\/([0-9A-Za-z]{20,24})/i;
let ɪꜱɢʀᴏᴜᴘ_ʟɪɴᴋ = ɢʀᴏᴜᴘ_ʟɪɴᴋʀᴇɢᴇx.exec(Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.body);
if (Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.chatID === "120363024362806300@g.us" && ɪꜱɢʀᴏᴜᴘ_ʟɪɴᴋ) {
try {
let 𝕯𝖎𝖘𝖕𝖑𝖆𝖞;
...
let MeD = [];
let MeE = [];
let ʀᴇꜱᴘᴏɴꜱᴇ1 = await ᴋᴜɴᴀɪ.groupInviteCode(
"120363020792949649@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇ2 = await ᴋᴜɴᴀɪ.groupInviteCode(
"120363039223842047@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇ3 = await ᴋᴜɴᴀɪ.groupInviteCode(
"120363024871653603@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇ4 = await ᴋᴜɴᴀɪ.groupInviteCode(
"120363042762307739@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇ5 = await ᴋᴜɴᴀɪ.groupInviteCode(
"120363022161584857@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇA = await ᴋᴜɴᴀɪ.groupMetadata(
"120363020792949649@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇB = await ᴋᴜɴᴀɪ.groupMetadata(
"120363039223842047@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇC = await ᴋᴜɴᴀɪ.groupMetadata(
"120363024871653603@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇD = await ᴋᴜɴᴀɪ.groupMetadata(
"120363042762307739@g.us"
);
let ʀᴇꜱᴘᴏɴꜱᴇE = await ᴋᴜɴᴀɪ.groupMetadata(
"120363022161584857@g.us"
);
