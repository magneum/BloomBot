...
module.exports = async (BloomBot, mags, update, store) => {
  ...
  BloomBot.mags_maker = mags_maker;
  ...
  BloomBot.tagname = mags.sender.replace(/['@s whatsapp.net']/g, "");
  ...
  BloomBot.magfetch = require("@/lib/magfetch");
