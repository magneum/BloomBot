...
╔════◇🌿𝐓𝐨𝐩𝐢𝐜: ${FinalName}
║ 𝗟𝗲𝘀𝗯𝗼 𝗠𝗲𝗺𝗯𝗲𝗿: _@${personreceived}_
...
╚════════════╝`
      ...
      const LesboBody =
        Type === "listResponseMessage" && chat.message.listResponseMessage.title
          ...
          : "";
      `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
      var LesboCheck = LesboBody.slice(1);
      var Tag = LesboCheck.split(" ").join("");
      var ToRm = ᴋᴇɪ + newScpt;
      var Num = ToRm.length;
      var Mention = Tag.substring(Num);
      var MentionPerson = Mention + "@s.whatsapp.net";
      const FinalLesbo = Math.ceil(Math.random() * 100);
      `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
      const buttonMessage = {
        contentText: `🦋𝐊𝐨𝐧𝐢𝐜𝐡𝐢𝐰𝐚

╔════◇🌿𝐓𝐨𝐩𝐢𝐜: ${FinalName}
║ 𝗟𝗲𝘀𝗯𝗼 𝗠𝗲𝗺𝗯𝗲𝗿: _@${Mention}_
║ 𝗔𝘀𝗸𝗲𝗱 𝗕𝘆: _@${ꜱᴇɴᴅᴇʀeceived}_
║ 𝗣𝗲𝗿𝗰𝗲𝗻𝘁𝗮𝗴𝗲: _${FinalLesbo}%_
╚════════════╝`,
