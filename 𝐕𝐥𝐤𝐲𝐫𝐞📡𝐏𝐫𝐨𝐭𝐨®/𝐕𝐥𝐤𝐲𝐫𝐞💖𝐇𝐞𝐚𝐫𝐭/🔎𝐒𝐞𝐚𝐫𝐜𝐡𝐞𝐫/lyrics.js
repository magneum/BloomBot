            ...
            try {
                ...
                */
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_`, dotScrpt);
                }
                /*
                ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                ...
                */
                try {
                    ...
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `📜 𝗟𝘆𝗿𝗶𝗰𝘀 𝗙𝗼𝘂𝗻𝗱 𝗙𝗼𝗿: _${ǟʀɢʊʍɛռȶ.join(` `)}_
...
${lyricssong.lyrics}`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                }
            }
            catch (error) {
