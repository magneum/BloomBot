...
: "";
let users = (await mention[0]) || 𝐕𝐥𝐤𝐲𝐫𝐞.msg.contextInfo.participant;
if (!users) {
return await N𝖊𝖊𝖉__A𝖗𝖌𝖘(
ӄ𝖗𝖞ӄ𝖓𝖟,
𝐕𝐥𝐤𝐲𝐫𝐞,
...
await ӄ𝖗𝖞ӄ𝖓𝖟.groupParticipantsUpdate(𝐕𝐥𝐤𝐲𝐫𝐞.chatID, [users], "promote");
ӄ𝖗𝖞ӄ𝖓𝖟.sendMessage(𝐕𝐥𝐤𝐲𝐫𝐞.chatID, {
text: `Looks like @${𝐕𝐥𝐤𝐲𝐫𝐞.sender.split("@")[0]} promoted @${
users.split("@")[0]
}`,
contextInfo: { mentionedJid: [users, 𝐕𝐥𝐤𝐲𝐫𝐞.sender] },
});
}
};
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═════════════════════════════════════════════════════════════════════⬡|");
