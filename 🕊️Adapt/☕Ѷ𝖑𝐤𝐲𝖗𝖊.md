...
<button onclick="window.location.href='https://chat.whatsapp.com/Gg4ctxbT6oN3K5h9OaGbug'"
...
<button onclick="window.location.href='https://chat.whatsapp.com/EgkBVJ7os0mClAJbk1X77Z'"
class="ml-4 inline-flex text-gray-900 bg-gray-200 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg">
2☕𝐕𝐥𝐤𝐲𝐫𝐞
</button>
</a>
...
<span class="ml-3 text-xl">❝ Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 𝐁𝐲 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ ❞</span>
</a>
