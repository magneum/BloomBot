        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (Vʟӄʏʀɛ.isReplyImage ||
                    ...
                    Vʟӄʏʀɛ.isReplyVideo ||
                    Vʟӄʏʀɛ.isTextReply) {
                    yield TUF.deleteMessage(Vʟӄʏʀɛ.chatId, {
                        id: Vʟӄʏʀɛ.replyMessageId,
                        remoteJid: Vʟӄʏʀɛ.chatId,
                        fromMe: true,
                    }).catch((error) => {
                        FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - reply to message sent by bot with: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}`, dotScrpt);
                    });
                }
                else {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - reply to message sent by bot with: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}`, dotScrpt);
                }
                // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
            }
            catch (error) {
