...
("⦓════════════════════════「  𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐀𝐩𝐢®  」══════════]  ʍǟɖɛ ɮʏ ӄʀǟӄɨռʐʟǟɮ™  [══════════「  𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐀𝐩𝐢®  」════════════════════════⦔");
async function yt_var(url, quality, type, bitrate, server = "en68") {
...
module.exports = {
yt_var,
yta_var(url, server = "en68") {
return yt_var(url, "128kbps", "mp3", "128", server);
},
ytv_var(url, server = "en68") {
return yt_var(url, "360p", "mp4", "360", server);
},
