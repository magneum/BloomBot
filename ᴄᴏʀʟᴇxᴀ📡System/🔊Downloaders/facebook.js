...
module.exports = {
name: newScpt,
𝖈𝖔𝖗𝖑𝖊𝖝𝖆ӄǟɨʐօ: `*${ᴋᴇɪ}${newScpt}* _facebook video link_`,
...
`|⬡════════════════════════════════════════════|   (𝐜)𝐂𝐨𝐫𝐥𝐞𝐱𝐚𝐀𝐈  🛸  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛   |═══════════════════════════════════════════⬡|`;
const UrlFetchAndSend = async (GetFile, url, MainText = "") => {
const Filename = Date.now();
let Mime = "";
var DownUrl = function (uri, Filename, callback) {
...
DownUrl(url, Filename, async function () {
console.log("done");
...
try {
await ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇.sendMessage(GetFile, Media, Type, {
quoted: chat,
mimetype: Mime,
caption: MainText,
...
`|⬡════════════════════════════════════════════|   (𝐜)𝐂𝐨𝐫𝐥𝐞𝐱𝐚𝐀𝐈  🛸  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛   |═══════════════════════════════════════════⬡|`;
if (!isUrl(Needs[0]) && !Needs[0].includes("facebook.com")) {
...
`|⬡════════════════════════════════════════════|   (𝐜)𝐂𝐨𝐫𝐥𝐞𝐱𝐚𝐀𝐈  🛸  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛   |═══════════════════════════════════════════⬡|`;
await Hx.fbdown(`${Needs.join(" ")}`).then((G) => {
UrlFetchAndSend(
𝖈𝖔𝖗𝖑𝖊𝖝𝖆.chatId,
`${G.HD}`,
`*FaceBook Downloader* : ${G.Normal_video}`
);
});
}
);
