    ...
    handle(TUF, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.log("💡𝐈𝐧𝐟𝐨: Is Sender Group Admin: " + AʀƈȶɨӼ.isSenderGroupAdmin);
                ...
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                let FinalLink;
                var AnimeLink = yield anime.highfive();
                ...
                if (!AnimeLink.endsWith(`.gif`) && !AnimeLink.endsWith(`.mp4`)) {
                    ...
                    FinalLink = yield anime2.highfive();
                }
                else {
                    FinalLink = AnimeLink;
                }
                ...
                try {
                    yield downloader
                        .download()
                        .then(console.log(`⬡═══════════════════| 🥂𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝 𝐅𝐢𝐧𝐢𝐬𝐞𝐝🥂 |═══════════════════⬡`));
                }
                catch (error) {
