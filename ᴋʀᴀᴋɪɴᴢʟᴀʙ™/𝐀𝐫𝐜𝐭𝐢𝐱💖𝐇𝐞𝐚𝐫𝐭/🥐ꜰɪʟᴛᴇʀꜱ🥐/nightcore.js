...
const Filter_Media = require(`../../𝐀𝐫𝐜𝐭𝐢𝐱🀄𝐕𝐞𝐧𝐭/Filter_Media`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const AudioSender = (fid, replyChat) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield saveBuffer(FileName, stream).then(() => Filter_Media.VFmedia(client, Fox, AʀƈȶɨӼ, FileName, ConvertedName, `-af "aresample=48000,asetrate=48000*1.25"`));
                });
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _reply to any audio in the chat_`,
                                    },
                                ],
                            },
                        ],
