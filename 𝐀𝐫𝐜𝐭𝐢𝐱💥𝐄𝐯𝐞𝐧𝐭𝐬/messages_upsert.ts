...
console.log("💡𝐈𝐧𝐟𝐨: Is Sender Admin?: " + AʀƈȶɨӼ.isSenderGroupAdmin);
console.log("💡𝐈𝐧𝐟𝐨: Is Arctix Admin?: " + AʀƈȶɨӼ.isBotGroupAdmin);
console.log("💡𝐈𝐧𝐟𝐨: Is Sender TUF?: " + AʀƈȶɨӼ.isSenderTUFs);
console.log(Fox);
console.log(Kolor.cyanBright("|════════════════════════「 𝐀𝐫𝐜𝐭𝐢𝐱 𝐀𝐩𝐢® 」════════════════════════|"));
await git.fetch();
