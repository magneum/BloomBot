                ...
                if (ǟʀɢʊʍɛռȶ[0] === `ON` ||
                    ...
                    Ranker.findOne({
                        ...
                        if (!server) {
                            ...
                            return yield TUF.sendMessage(Vʟӄʏʀɛ.chatId, {
                                quoted: Fox.message,
                                contextInfo: {
...
🌱𝗕𝘂𝘁𝘁𝗼𝗻𝘀 𝗧𝗼 𝗧𝗼𝗴𝗴𝗹𝗲 𝗔𝘂𝘁𝗼𝗥𝗮𝗻𝗸👇🏽‍`,
                                ...
                                buttons: [
                                    {
                                        buttonId: `${______1.default.MuveOn}autorank on`,
                                        buttonText: {
                                            displayText: `${______1.default.MuveOn}autorank on`,
                                        },
                                        type: 1,
                                    },
                                    {
                                        buttonId: `${______1.default.MuveOn}autorank off`,
                                        buttonText: {
                                            displayText: `${______1.default.MuveOn}autorank off`,
                                        },
                                        type: 1,
                                    },
                                ],
                                headerType: 4,
                            }, message_type_1.MessageType.buttonsMessage).catch((error) => Oops.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                            // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                        }
                        else {
                            return yield TUF.sendMessage(Vʟӄʏʀɛ.chatId, {
