...
module.exports = ӄ𝖚𝖓𝖆𝖎 = async (ӄ𝖚𝖓𝖆, Ѷ𝖆𝖑𝐤𝐲𝖗𝖎, chatUpdate, Ѷ𝖎𝖔𝖓) => {
  ...
  await userBanCheck.findOne(
    ...
    async (error, userBCheck) => {
      ...
      if (!isSenderTUF && !fromMe && isCommand) {
        let MEMBER_A = [];
        let MEMBER_B = [];
        let MEMBER_C = [];
        let MEMBER_D = [];
        let MEMBER_E = [];
        const MetaFor_A = await ӄ𝖚𝖓𝖆𝖎.groupMetadata("120363020792949649@g.us");
        const MetaFor_B = await ӄ𝖚𝖓𝖆𝖎.groupMetadata("120363024871653603@g.us");
        const MetaFor_C = await ӄ𝖚𝖓𝖆𝖎.groupMetadata("120363042762307739@g.us");
        const MetaFor_D = await ӄ𝖚𝖓𝖆𝖎.groupMetadata("120363022161584857@g.us");
        const MetaFor_E = await ӄ𝖚𝖓𝖆𝖎.groupMetadata("120363039223842047@g.us");
