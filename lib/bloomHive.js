...
exports.mags_maker = async (BloomBot, mags, store) => {
  if (!mags) return mags;
  ...
  if (mags.message) {
    ...
    if (mags.quoted) {
      ...
      mags.getQuotedObj = mags.getQuotedMessage = async () => {
        ...
        return exports.mags_maker(BloomBot, q, store);
      };
  ...
  mags.copy = () =>
    exports.mags_maker(BloomBot, νproto.fromObject(νproto.toObject(mags)));
