...
try:
    output = subprocess.run(["node", "contents.js"], check=True, capture_output=True, text=True)
    print(output.stdout)

    repo = git.Repo.init(path='.', initial_branch='magneum')
<<<<<<< HEAD
    origin = repo.create_remote('origin', 'https://github.com/magneum/WhatsBot')
=======
    origin = repo.create_remote('origin', 'https://github.com/magneum/Voxbot')
>>>>>>> 17f52fe472c04e519779246ebe3026ed85ef536a
