...
╚════════════╝`,
    ...
    ӄʀǟӄɨռʐ.on(`chat-update`, async (chat) => {
      ...
      if (!_𝔏𝔞𝔟_.DEVL === undefined && !ֆǟӄʊʀǟ.fromMe) return;
      `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
...
╔════| (𝐜)𝐒𝐚𝐤𝐮𝐫𝐚 _by_ ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛
║
║❌ _No Such Command In Database!_
║🍃 *Press Below Buttons For Commands.*
╚════════════╝`
                );
                `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
              } else {
      ...
      } else if (!ֆǟӄʊʀǟ.isGroup && !ֆǟӄʊʀǟ.fromMe && !ֆǟӄʊʀǟ.isSenderDev) {
        Ban.findOne(
          {
            ID: աɦօֆɛռȶɦǟȶ,
            serverID: ֆǟӄʊʀǟ.chatId,
