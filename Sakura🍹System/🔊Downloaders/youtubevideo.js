...
module.exports = {
  name: newScpt,
  ֆǟӄʊʀǟӄǟɨʐօ: `*${ᴋᴇɪ}youtubevideo* _song name_
...
╚════════════╝`
          ...
          async function FFMPEG_GOT(Link, Title, Found) {
            ...
            var YouFile = `${Date.now()}_${Title}.mp4`;
            try {
...
𝗣𝗹𝗲𝗮𝘀𝗲 𝗖𝗵𝗼𝗼𝘀𝗲 𝗦𝗺𝗮𝗹𝗹𝗲𝗿 𝐕𝐢𝐝𝐞𝐨 𝗧𝗵𝗲𝗻 30-𝗺𝗶𝗻𝘂𝘁𝗲𝘀!
...
╚════════════╝`,
            ...
            Sakura_Buttons.MTB(
              ...
              chat,
              ֆǟӄʊʀǟ,
              `✋🏽‍𝐊𝐨𝐧𝐢𝐜𝐡𝐢𝐰𝐚 @${ꜱᴇɴᴅᴇʀeceived}, 𝗣𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗳𝗼𝗿 𝘁𝗵𝗲 𝗱𝗲𝗹𝗶𝘃𝗲𝗿𝘆 𝗼𝗳 🎬𝐕𝐢𝐝𝐞𝐨!`
            );
            `|⬡===========================================|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |===========================================⬡|`;
