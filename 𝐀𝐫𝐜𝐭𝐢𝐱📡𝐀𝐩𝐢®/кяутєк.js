...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    chalk_animation_1.default.rainbow('" |════════════════════════════════════════════|    |═══════════════════════════════════════════| "');
    chalk_animation_1.default.karaoke(" (𝐜)𝐀𝐫𝐜𝐭𝐢𝐱 𝐢𝐬 𝐚 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐌𝐮𝐥𝐭𝐢𝐏𝐮𝐫𝐩𝐨𝐬𝐞-𝐔𝐬𝐞𝐫𝐛𝐨𝐭 𝐰𝐢𝐭𝐡 𝐌𝐨𝐝𝐞𝐫𝐚𝐭𝐢𝐨𝐧,𝐀𝐮𝐭𝐨𝐦𝐚𝐭𝐢𝐨𝐧 𝐚𝐧𝐝 𝟏𝟎𝟎+ 𝐦𝐨𝐫𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬! ");
    chalk_animation_1.default.rainbow('" |════════════════════════════════════════════|    |═══════════════════════════════════════════| "');
    //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
    ...
    const startSock = () => __awaiter(void 0, void 0, void 0, function* () {
        const ӄʀʏȶɛӄ = (0, baileys_1.default)({
            logger,
        ...
        //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
        store === null || store === void 0 ? void 0 : store.bind(ӄʀʏȶɛӄ.ev);
        ӄʀʏȶɛӄ.ev.on("group-participants.update", (update) => __awaiter(void 0, void 0, void 0, function* () {
            participants_update_1.default.participants_update(update, ӄʀʏȶɛӄ);
        }));
