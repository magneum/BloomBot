...
let isLink = LinkRegex.exec(ᴠʟᴋʏʀᴇ.body);
if (
ᴠʟᴋʏʀᴇ.isPm &&
isLink &&
...
return Text.match(/chat.whatsapp.com\/([0-9A-Za-z]{20,24})/gi);
}
var FINAL = extract(ᴠʟᴋʏʀᴇ.body);
try {
await ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇.acceptInvite(FINAL.toString()).then(async (res) => {
const gD = await ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇.groupMetadata(res.gid);
if (gD.participants.length < 15) {
...
❌𝐍𝐎𝐓 𝐕𝐄𝐑𝐈𝐅𝐈𝐄𝐃❌ 
🌐𝐖𝐞𝐛𝐬𝐢𝐭𝐞: VlkyreAI.krakinzkon.repl.co
*OR*
