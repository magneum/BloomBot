...
ӄ === null || ӄ === void 0 ? void 0 : ӄ.readFromFile("./Vʟӄʏʀɛ.json");
setInterval(() => {
    ӄ === null || ӄ === void 0 ? void 0 : ӄ.writeToFile("./Vʟӄʏʀɛ.json");
}, 1000);
// Zygote.findOne(
// {
// ID: ӄ,
...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(chalk_1.default.green("💡𝐈𝐧𝐟𝐨: Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 connected to servers and verified..."));
    chalkAnimation.rainbow(" (𝐜)𝐕𝐥𝐤𝐲𝐫𝐞 𝐢𝐬 𝐚 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐌𝐮𝐥𝐭𝐢𝐏𝐮𝐫𝐩𝐨𝐬𝐞-𝐔𝐬𝐞𝐫𝐛𝐨𝐭 𝐰𝐢𝐭𝐡 𝐌𝐨𝐝𝐞𝐫𝐚𝐭𝐢𝐨𝐧,𝐀𝐮𝐭𝐨𝐦𝐚𝐭𝐢𝐨𝐧 𝐚𝐧𝐝 𝟏𝟎𝟎+ 𝐦𝐨𝐫𝐞 𝐜𝐨𝐦𝐦𝐚𝐧𝐝𝐬! ");
    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
    let commandHandler = new Map();
    let Folders = fs_1.default.readdirSync((0, path_1.join)(__dirname, "𝐕𝐥𝐤𝐲𝐫𝐞💖𝐇𝐞𝐚𝐫𝐭"));
    for (const Files of Folders) {
        const AllFiles = fs_1.default
            .readdirSync((0, path_1.join)(__dirname, `./𝐕𝐥𝐤𝐲𝐫𝐞💖𝐇𝐞𝐚𝐫𝐭/${Files}`))
