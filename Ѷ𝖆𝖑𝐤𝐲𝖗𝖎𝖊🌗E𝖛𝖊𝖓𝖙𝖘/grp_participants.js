...
var Welcome = require(`../Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊🧆𝕯𝖆𝖙𝖆𝖇𝖆𝖘𝖊/🍃𝖒𝖔𝖓𝖌𝖔/setwelcome`);
exports.grp_participants = async (Group, ӄ𝖚𝖓𝖆𝖎) => {
  try {
    var 𝖕𝖋𝖕𝖀𝖘𝖊𝖗;
    var 𝖕𝖋𝖕𝕲𝖗𝖔𝖚𝖕;
    var GrpMETA = await ӄ𝖚𝖓𝖆𝖎.groupMetadata(Group.id);
    var GrpName = GrpMETA.subject || "";
    var GrpPart = Group.participants;
    `|⬡════════════════════════════════════════════════════════════════════「  𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐀𝐩𝐢®  」═══════════════════════════════════════════════════════════════════⬡|`;
    for (var One of GrpPart) {
      try {
