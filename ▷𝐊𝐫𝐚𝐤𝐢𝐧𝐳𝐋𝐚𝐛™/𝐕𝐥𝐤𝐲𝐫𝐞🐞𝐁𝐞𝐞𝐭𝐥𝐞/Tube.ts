...
function post(url: any, formdata: any) {
return fetch(url, {
method: "POST",
headers: {
accept: "*/*",
...
//" |════════════════════════════════════════════| Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
async function yt(url: any, quality: any, type: any, bitrate: any, server = "en68") {
...
module.exports = {
yt,
yta(url: any, server = "en68") {
return yt(url, "128kbps", "mp3", "128", server);
},
ytv(url: any, server = "en68") {
