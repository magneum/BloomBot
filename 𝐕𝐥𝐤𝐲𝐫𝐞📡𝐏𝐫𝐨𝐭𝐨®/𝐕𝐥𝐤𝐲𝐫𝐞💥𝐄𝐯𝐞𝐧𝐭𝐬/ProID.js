...
const ProID = (TUF, Fox, Vʟӄʏʀɛ, ӄ𝖗𝖞ӄ𝖓𝖟) => __awaiter(void 0, void 0, void 0, function* () {
    if (Vʟӄʏʀɛ.chatId === "120363024362806300@g.us" &&
        ...
        // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
        yield ӄ𝖗𝖞ӄ𝖓𝖟.groupAcceptInvite(MetaCode).then((Response) => __awaiter(void 0, void 0, void 0, function* () {
            const metadata = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupMetadata(Response.gid);
            console.log(Response);
            let 𝕻𝕻𝖑𝖊𝖙𝖊𝖗;
            try {
                𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = yield ӄ𝖗𝖞ӄ𝖓𝖟.profilePictureUrl(Response.gid, "image");
            }
            catch (_a) {
                𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png";
            }
            if (!Vʟӄʏʀɛ.isSenderTUFs && metadata.participants.length < 20) {
                yield ӄ𝖗𝖞ӄ𝖓𝖟.groupLeave(Response.gid);
                return Image_Button.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌ 𝗘𝗿𝗿𝗼𝗿: _${metadata.participants.length}/20 members!_
📜 𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞: ${metadata.subject}`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
            }
            else {
                return Image_Button.VImg(TUF, Fox, Vʟӄʏʀɛ, `🔓 𝐒𝐭𝐚𝐭𝐮𝐬: _Joined Group!_
📜 𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞: ${metadata.subject}
💞 𝐌𝐞𝐦𝐛𝐞𝐫 𝐂𝐨𝐮𝐧𝐭: ${metadata.participants.length}
📝 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${metadata.desc}`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
            }
        }));
    }
});
