...
module.exports = {
name: newScpt,
ƈօʀȶǟռǟӄǟɨʐօ: `*Reply Media With:* _${ᴋᴇɪ}${newScpt}_
...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐂𝐨𝐫𝐭𝐚𝐧𝐚𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
if (ƈօʀȶǟռǟ.type === "image" || ƈօʀȶǟռǟ.isReplyImage) {
ffmpeg(FilePath)
...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐂𝐨𝐫𝐭𝐚𝐧𝐚𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
if (ƈօʀȶǟռǟ.isImage || ƈօʀȶǟռǟ.isGIF || ƈօʀȶǟռǟ.isVideo) {
var replyChatObject = {
...
ƈօʀȶǟռǟ.isReplyImage ||
ƈօʀȶǟռǟ.isReplyGIF ||
ƈօʀȶǟռǟ.isReplyVideo
) {
var replyChatObject = {
message:
