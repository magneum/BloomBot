...
let Welcome = require(`../•dBase/🍃𝖒𝖔𝖓𝖌𝖔/setwelcome`);
...
𝖕𝖋𝖕𝖀𝖘𝖊𝖗 = "./•Assests/Vlkyre_LabGreen.png";
}
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
...
return await ӄryӄnz.sendMessage(𝖚𝖕𝖉𝖆𝖙𝖊.id, {
contextInfo: { mentionedJid: [𝖚𝖕𝖉𝖆𝖙𝖊.participants[0]] },
image: { url: 𝖕𝖋𝖕𝖀𝖘𝖊𝖗 },
caption: `┌╔══『 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 』
│║༒ 💡𝐧𝐚𝐦𝐞/𝐧𝐮𝐦: @${𝖚𝖘𝖊𝖗𝕹𝖆𝖒𝖊}
│║༒ 🎐𝐠𝐫𝐨𝐮𝐩: ${𝕲𝖗𝖔𝖚𝖕𝖒𝖊𝖙𝖆.subject || ""}
│║༒ ⏰𝐜𝐫𝐞𝐚𝐭𝐞𝐝: ${moment(`${𝕲𝖗𝖔𝖚𝖕𝖒𝖊𝖙𝖆.creation}` * 1000).tz("Asia/Kolkata").format("DD/MM/YYYY HH:mm:ss")}
•╚═══════⋑
