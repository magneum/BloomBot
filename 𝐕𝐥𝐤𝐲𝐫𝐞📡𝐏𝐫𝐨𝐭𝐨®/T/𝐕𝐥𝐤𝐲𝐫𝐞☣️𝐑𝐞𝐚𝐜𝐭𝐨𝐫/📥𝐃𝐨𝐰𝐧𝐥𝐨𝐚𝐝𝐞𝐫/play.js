...
⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
*/
const TubeAudio = require("../../𝐕𝐥𝐤𝐲𝐫𝐞💽𝐌𝐞𝐝𝐢𝐚/TubeAudio");
            ...
            TubeFile.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (Found.seconds > 1800) {
                        Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Audio less then 30mins!_

⭕️𝐘𝐨𝐮𝐓𝐮𝐛𝐞 𝐀𝐈: ${Found.title}
🍻𝐓𝐢𝐭𝐥𝐞: ${Found.title}
⏰𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧: ${Found.timestamp}`, Found.thumbnail);
                    }
                    return yield TubeAudio.VTaud(TUF, Fox, Vʟӄʏʀɛ, Found);
                });
            });
        });
    },
