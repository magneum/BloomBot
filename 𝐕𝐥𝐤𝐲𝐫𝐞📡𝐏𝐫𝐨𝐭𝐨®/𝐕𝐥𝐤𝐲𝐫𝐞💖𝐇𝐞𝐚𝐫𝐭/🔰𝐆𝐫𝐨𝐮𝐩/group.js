        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (ǟʀɢʊʍɛռȶ[0] === `CLOSE` ||
                    ǟʀɢʊʍɛռȶ[0] === `Close` ||
                    ǟʀɢʊʍɛռȶ[0] === `close`) {
                    yield ӄ𝖗𝖞ӄ𝖓𝖟.groupSettingUpdate(Vʟӄʏʀɛ.chatId, "announcement");
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡𝐈𝐧𝐟𝐨: Current Group Setting Has Been Changed To: _only admins to send messages_`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else if (ǟʀɢʊʍɛռȶ[0] === `OPEN` ||
                    ǟʀɢʊʍɛռȶ[0] === `Open` ||
                    ǟʀɢʊʍɛռȶ[0] === `open`) {
                    yield ӄ𝖗𝖞ӄ𝖓𝖟.groupSettingUpdate(Vʟӄʏʀɛ.chatId, "not_announcement");
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡𝐈𝐧𝐟𝐨: Current Group Setting Has Been Changed To: _everyone can send messages_`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _CLOSE/Close/close_
