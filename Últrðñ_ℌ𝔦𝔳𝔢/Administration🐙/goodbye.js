...
module.exports = {
  ...
  ƈʏɮօʀɢʍօʀɛ: `A goodbye message will be sent when any member leaves the group. It can be an image, video, gif with caption or just a text message.\n\nUse this module to either set, update or delete the existing message.\n\nThe goodbye option can be disabled but saved using the  *${config.PREFIX}goodbye  off*  command. In order to delete the existing message, use  *${config.PREFIX}goodbye  delete*${config.PREFIX}  Do note, the goodbye option is still enabled after you use the delete option.`,
