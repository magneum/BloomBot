...
╚════════════╝`
                                      ...
                                      const MoneyRobbed =
                                        Math.floor(
                                          Math.random() * (300 - 150 + 1)
                                        ) + 150;
                                      const LaptopRem =
                                        Math.floor(
                                          Math.random() * (2000 - 1500 + 1)
                                        ) + 1500;
                                      const charmRem =
                                        Math.floor(
                                          Math.random() * (3000 - 2500 + 1)
                                        ) + 2500;
                                      const PadLockRem =
                                        Math.floor(
                                          Math.random() * (500 - 350 + 1)
                                        ) + 350;
                                      const swordRem =
                                        Math.floor(
                                          Math.random() * (1500 - 1000 + 1)
                                        ) + 1000;
                                      `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
                                      if (
...
║
║❓ 𝗕𝗲𝗳𝗼𝗿𝗲 𝗥𝗼𝗯𝗯𝗲𝗿𝘆: _${CulpritEconomy.money}gold_
║💸 𝗔𝗳𝘁𝗲𝗿 𝗥𝗼𝗯𝗯𝗲𝗿𝘆: _${CulpritEconomy.money + MoneyRobbed}gold_
║
╚═══◇║
╔═══◇║💀𝐕𝐢𝐜𝐭𝐢𝐦: @${քɛʀֆօռɢօȶռʊʍ}
║
║❓ 𝗕𝗲𝗳𝗼𝗿𝗲 𝗥𝗼𝗯𝗯𝗲𝗿𝘆: _${VictimEconomy.money}gold_
║🥲 𝗔𝗳𝘁𝗲𝗿 𝗥𝗼𝗯𝗯𝗲𝗿𝘆: _${VictimEconomy.money - MoneyRobbed}gold_
╚════════════╝`
                                      );
                                    }
                                  }
