...
const ToStickerVideo = (TUF, Fox, ǟʀɢʊʍɛռȶ, Vʟӄʏʀɛ, FileID, FileSocket) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
        ...
        const ConvertedVideo = "./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/A-" + FileID + ".mp4";
        ...
        try {
            ...
            yield Video_Button_1.default.VVid(TUF, Fox, Vʟӄʏʀɛ, res, `💡𝐈𝐧𝐟𝐨: Here is your Sticker To Video Converted File.`);
