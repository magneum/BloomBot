...
シ︎𝙎𝙥𝙖𝙢/𝙏𝙚𝙨𝙩 𝐆𝐫𝐨𝐮𝐩🛸 https://chat.whatsapp.com/GDNPVuH3eMq72UOUHavZxH`,
    ...
    // ⬡==================⬡-----------------⦿𝐌𝐞𝐞𝟔™⦿-----------------⬡==================⬡
    if (!爪𝖎𝖟𝖚ӄ𝖎6.isReply && typeof arg[0] == `undefined`) {
      𝓚𝓻𝓪𝓴𝓲𝓷𝔃
        .sendMessage(
          爪𝖎𝖟𝖚ӄ𝖎6.chatId,
    ...
    if (!arg.length > 0) {
      ...
      contact = async (arg, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎6) => {
        var JoinIDNum = ``;
...
3. +(YYY)XXXXXXXXXX _(YY- Country Code, without zeros)_`,
    ...
    if (contact === 爪𝖎𝖟𝖚ӄ𝖎6.owner.split(`@`)[0]) {
      𝓚𝓻𝓪𝓴𝓲𝓷𝔃
        .sendMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `Bot can not ban itself`, MessageType.text)
        .catch((error) => ℓιєηт.catch(error, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎6));
      return;
    }
