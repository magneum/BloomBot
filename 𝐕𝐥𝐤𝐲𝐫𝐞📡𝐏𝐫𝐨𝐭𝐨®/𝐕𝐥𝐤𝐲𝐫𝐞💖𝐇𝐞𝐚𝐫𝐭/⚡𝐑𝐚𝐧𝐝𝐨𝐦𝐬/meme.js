    ...
    handle(TUF, Fox, Vʟӄʏʀɛ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!json[0]) {
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `😂𝐌𝐞𝐌𝐞: _Your Life Lmfao!_`, "https://i.postimg.cc/9Xkbbm7m/meme.png");
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else {
                    const data = json[0].data.children[0].data;
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `😂𝐌𝐞𝐌𝐞
