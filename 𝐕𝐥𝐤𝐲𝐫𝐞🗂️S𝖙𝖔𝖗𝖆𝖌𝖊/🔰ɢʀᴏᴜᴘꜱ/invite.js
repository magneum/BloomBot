...
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═════════════════════════════════════════════════════════════════════⬡|");
let Igroup = await group.findOne({ id: Ѷ𝖑𝐤𝐲𝖗𝖊.chatID });
let hh = Igroup.invite || `false`;
if (hh == `false`)
return Ѷ𝖑𝐤𝐲𝖗𝖊.reply(`*❌ERROR:* *Invite* is not active in this group`);
let response = await ӄ𝖗𝖞ӄ𝖓𝖟.groupInviteCode(Ѷ𝖑𝐤𝐲𝖗𝖊.chatID);
