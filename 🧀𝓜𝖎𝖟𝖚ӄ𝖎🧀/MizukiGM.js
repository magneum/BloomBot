...
exports.MizukiGM = async (ӄʀǟӄɨռʐ, chat, 𝓜𝖎𝖟𝖚ӄ𝖎) => {
  ...
  if (𝓜𝖎𝖟𝖚ӄ𝖎.isReply) {
    ...
    try {
      ...
      await ffmpeg(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.gif`)
        .outputOptions([
          "-pix_fmt yuv420p",
          "-c:v libx264",
          "-movflags +faststart",
        ...
        .save(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.mp4`)
        .on("end", async () => {
          console.log("Finished");
          await ӄʀǟӄɨռʐ
            .sendMessage(
              𝓜𝖎𝖟𝖚ӄ𝖎.chatId,
              fs.readFileSync(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.mp4`),
              MessageType.video,
              {
...
🤩𝐓𝐨: @${personreceived} `,
            ...
            .then(
              fs.unlinkSync(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.gif`),
              fs.unlinkSync(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.mp4`)
            );
        })
  ...
  if (!𝓜𝖎𝖟𝖚ӄ𝖎.isReply) {
    ...
    try {
      await downloader.download();
      ffmpeg(`./🗑️𝓜𝖎𝖟𝖚ӄ𝖎🗑️/${FinalName}_${MizukiGMid}.gif`)
        .outputOptions([
          "-pix_fmt yuv420p",
          "-c:v libx264",
          "-movflags +faststart",
