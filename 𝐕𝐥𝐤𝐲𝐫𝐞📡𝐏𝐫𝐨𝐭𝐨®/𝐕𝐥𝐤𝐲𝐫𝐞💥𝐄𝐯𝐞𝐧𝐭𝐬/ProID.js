...
const ProID = (TUF, Fox, Vʟӄʏʀɛ, ӄ𝖗𝖞ӄ𝖓𝖟) => __awaiter(void 0, void 0, void 0, function* () {
    if (Vʟӄʏʀɛ.isCmd)
        return;
    let MetaCode;
    try {
        let [_, Code] = Vʟӄʏʀɛ.body.match(/chat.whatsapp.com\/([0-9A-Za-z]{20,24})/i) || [];
        MetaCode = Code;
    }
    catch (error) {
    ...
    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
    const GroupMetadata = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupGetInviteInfo(MetaCode);
    console.log(GroupMetadata);
    let 𝕻𝕻𝖑𝖊𝖙𝖊𝖗;
    try {
        𝕻𝕻𝖑𝖊𝖙𝖊𝖗 = yield ӄ𝖗𝖞ӄ𝖓𝖟.profilePictureUrl(GroupMetadata.gid, "image");
    }
    catch (_a) {
    ...
    if (GroupMetadata.size < 20) {
        return yield Image_Button.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌𝗘𝗿𝗿𝗼𝗿: ${GroupMetadata.subject} has _${GroupMetadata.size}/20 members!_`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
    }
    else {
        yield ӄ𝖗𝖞ӄ𝖓𝖟.groupAcceptInvite(MetaCode);
        return yield Image_Button.VImg(TUF, Fox, Vʟӄʏʀɛ, `🔓𝐒𝐭𝐚𝐭𝐮𝐬: _Auto Joined Group!_

📜𝐆𝐫𝐨𝐮𝐩: ${GroupMetadata.subject}
💞𝐌𝐞𝐦𝐛𝐞𝐫: ${GroupMetadata.size}
📝𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${GroupMetadata.desc}`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
    }
});
("⦓⬡════════════════════════════════════════════|❝ Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡⦔");
/*
