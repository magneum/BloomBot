...
// ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
const TubeAudio = (TUF, Fox, Vʟӄʏʀɛ, Found) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { dl_link, thumb, title, filesizeF } = yield yta(Found.url, "id4");
        let DirectFile;
        try {
        ...
        // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
        yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `𝐘𝐨𝐮𝐓𝐮𝐛𝐞⭕️𝐌𝐮𝐬𝐢𝐜
🍻𝐓𝐢𝐭𝐥𝐞: ${Found.title}
🙈𝐕𝐢𝐞𝐰𝐬: ${Found.views}
...
📜𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${Found.description}`, Found.thumbnail);
        ...
        try {
            ...
            return yield TUF.sendMessage(Vʟӄʏʀɛ.chatId, fs.readFileSync(FFmpegFile), message_type_1.MessageType.audio, { quoted: Fox, mimetype: "audio/mp4" })
