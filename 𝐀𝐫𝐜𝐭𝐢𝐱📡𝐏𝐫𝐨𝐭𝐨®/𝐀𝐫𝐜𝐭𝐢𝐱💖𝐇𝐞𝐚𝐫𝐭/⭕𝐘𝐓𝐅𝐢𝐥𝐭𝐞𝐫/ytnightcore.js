        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            */
            if (ǟʀɢʊʍɛռȶ.length === 0) {
                return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_
...
Option 2 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _youtube link_`, dotScrpt);
            ...
            */
            ...
            if (!LinkFound) {
                Text_List_1.default.VText(TUF, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: No Music Found!`);
                return;
            }
            /*
            ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
            ...
            Videos.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (Found.seconds > 1800) {
                        return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Video less then 30mins!_
