...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_`,
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                const FetchedLink = yield yts(args.join(" "));
...
\n\n`;
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                if (Fetched === "") {
                    return Oops.VOp(client, Fox, AʀƈȶɨӼ, "❌𝐄𝐫𝐫𝐨𝐫꧂ No videos could be found.");
                }
                else {
                    return Image_Button.VImg(client, Fox, AʀƈȶɨӼ, `𝐘𝐨𝐮𝐓𝐮𝐛𝐞⭕𝐀𝐏𝐈
