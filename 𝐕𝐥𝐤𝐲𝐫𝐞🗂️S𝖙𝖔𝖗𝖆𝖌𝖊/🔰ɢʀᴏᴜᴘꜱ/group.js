...
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═════════════════════════════════════════════════════════════════════⬡|");
if (𝐕𝐥𝐤𝐲𝐫𝐞.A𝖗𝖌𝖘[0] === `open`) {
await ӄ𝖗𝖞ӄ𝖓𝖟
.groupSettingUpdate(𝐕𝐥𝐤𝐲𝐫𝐞.chatID, `not_announcement`)
.catch((Èrrðr) => 𝐕𝐥𝐤𝐲𝐫𝐞.reply(jsonformat(Èrrðr)));
} else if (𝐕𝐥𝐤𝐲𝐫𝐞.A𝖗𝖌𝖘[0] === `close`) {
await ӄ𝖗𝖞ӄ𝖓𝖟
.groupSettingUpdate(𝐕𝐥𝐤𝐲𝐫𝐞.chatID, `announcement`)
.catch((Èrrðr) => 𝐕𝐥𝐤𝐲𝐫𝐞.reply(jsonformat(Èrrðr)));
} else {
