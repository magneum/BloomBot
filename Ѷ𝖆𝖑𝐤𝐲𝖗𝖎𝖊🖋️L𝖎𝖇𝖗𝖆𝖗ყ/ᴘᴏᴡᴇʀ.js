...
async function Counter(VjHDlEOgvWPpRBs9FRGgJcKpDimTqf) {
let VjHDlEOgvWPpRBs9FRGgJcKpD = +VjHDlEOgvWPpRBs9FRGgJcKpDimTqf;
let { QuickDB } = require("quick.db");
let DB = new QuickDB({ filePath: "./src/Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.sqlite" });
await DB.set("User", { difficulty: "Hard" });
await DB.push("User.Used", VjHDlEOgvWPpRBs9FRGgJcKpD);
let C = await DB.get("User.Used");
console.log(ᴋᴏʟᴏʀ.black(ᴋᴏʟᴏʀ.bgWhite("🔥𝖀𝖘𝖊𝖉: "), ᴋᴏʟᴏʀ.bgGreen(C)));
}
`|⬡════════════════════════════════════════════════════════════════════「  𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐀𝐩𝐢®  」═══════════════════════════════════════════════════════════════════⬡|`;
if (Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.isCommmand && !process.env.DEBUG === undefined && !Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.fromMe) {
return await ᴋᴜɴᴀɪ.sendMessage(
Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.chatID,
{
text: `*❌𝕰𝖗𝖗𝖔𝖗:* ${
Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.pushName || "No_Name"
} Bot Under Maintenance Mode..`,
},
{
quoted: Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊,
}
