        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                */
                Pokemon.findOne({
                    ID: ʟɴᴀᴍᴇ,
                }, (error, userHunt) => __awaiter(this, void 0, void 0, function* () {
                    if (error)
                    ...
                    if (!userHunt) {
                        ...
                        return yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `⚠️𝐄𝐫𝐫𝐨𝐫: Addded To Database!
💡𝐈𝐧𝐟𝐨: Try The Command Again!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                    }
                    /*
                    ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                    「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
...
┊ 𝐌𝐢𝐧𝐞𝐜𝐫𝐚𝐟𝐭 🪵 𝐄𝐝𝐢𝐭𝐢𝐨𝐧
╚◇══════════════◇╝
❌𝗘𝗿𝗿𝗼𝗿: _You Are Very New! Better Luck Next Time!_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                            1;
                        }
                        /*
                        ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                        ...
                        */
                        let PokemonData;
                        try {
                            let res = yield fetch(global.API(`https://some-random-api.ml`, `/pokedex`, {
                                pokemon: BasePoke.toLowerCase(),
                            })).catch((error) => Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                            PokemonData = yield res.json();
                        }
                        catch (_a) {
                            return Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error);
                        }
                        ...
                        ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                        */
                        if (userHunt.PermanentLimitTime -
                            (Date.now() - userHunt.CurrentLimitTime) >
                            0) {
                            let time = ms(userHunt.PermanentLimitTime -
                                (Date.now() - userHunt.CurrentLimitTime));
                            return yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `
╔◇══════════════◇╗
┊ 𝐏𝐨𝐤𝐞𝐦𝐨𝐧🦋𝐇𝐮𝐧𝐭𝐢𝐧𝐠
...
💡𝐈𝐧𝐟𝐨: Hunt againin  _${time.hours}h ${time.minutes}m ${time.seconds}s_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                        }
                        /*
                        ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                        「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                        ...
                        */
                        ...
                        yield pokemon.card
                            ...
                            .then((card) => __awaiter(this, void 0, void 0, function* () {
                            if (!card) {
                                yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `
╔◇══════════════◇╗
┊ 𝐏𝐨𝐤𝐞𝐦𝐨𝐧🦋𝐇𝐮𝐧𝐭𝐢𝐧𝐠
┊ 𝐌𝐢𝐧𝐞𝐜𝐫𝐚𝐟𝐭 🪵 𝐄𝐝𝐢𝐭𝐢𝐨𝐧
╚◇══════════════◇╝
⚠️𝗘𝗿𝗿𝗼𝗿: _Caught Nothing!_
💡𝐈𝐧𝐟𝐨: Worth _0gold_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                                yield userEco
                                    .save()
                                    .catch((error) => Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                                yield userHunt
                            ...
                            */
                            ...
                            ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                            */
                            require("child_process").exec(`ffmpeg -i "${PokemonData.sprites.animated}" -pix_fmt yuv420p -c:v libx264 -movflags +faststart -filter:v crop='floor(in_w/2)*2:floor(in_h/2)*2' "./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/${Fox.key.id}.mp4"`, (error) => __awaiter(this, void 0, void 0, function* () {
                                if (error) {
                                    yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `
╔◇══════════════◇╗
┊ 𝐏𝐨𝐤𝐞𝐦𝐨𝐧🦋𝐇𝐮𝐧𝐭𝐢𝐧𝐠
...
💡𝐈𝐧𝐟𝐨: Worth _0gold_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                                ...
                                ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                                */
                                yield Video_Button_1.default.VVid(TUF, Fox, Vʟӄʏʀɛ, `./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/${Fox.key.id}.mp4`, `
╔◇══════════════◇╗
┊ 𝐏𝐨𝐤𝐞𝐦𝐨𝐧🦋𝐇𝐮𝐧𝐭𝐢𝐧𝐠
┊ 𝐌𝐢𝐧𝐞𝐜𝐫𝐚𝐟𝐭 🪵 𝐄𝐝𝐢𝐭𝐢𝐨𝐧
╚◇══════════════◇╝
...
𝐓𝐨 𝐋𝐞𝐚𝐫𝐧 𝐌𝐨𝐫𝐞👇🏻
💫 *Type:* _${______1.default.MuveOn}pokedex ${PokemonData.name}_
💫 *Type:* _${______1.default.MuveOn}pokemon ${PokemonData.name}_`);
                                yield VOID.VOID(`./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/${Fox.key.id}.mp4`);
                            }));
                        }));
                    }));
                }));
