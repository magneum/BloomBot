...
*⚡Usage* 
> _${Foxbot.prefix}${finalname} reply/send image_`
      );
    }
    if (/webp/.test(Foxbot.mime)) {
      await Foxbot.sendMessage(Foxchat.chat, {
        react: {
          text: "❌",
          key: Foxchat.key,
...
> _${Foxbot.prefix}${finalname} reply/send image_`
    ...
    var media = await Foxbot.downloadAndSaveMediaMessage(Foxbot.quoted);
    await Foxbot
      .updateProfilePicture(Foxchat.chat, { url: media })
      .then(
        Foxbot.imagebutton(
          Foxbot,
          Foxchat,
