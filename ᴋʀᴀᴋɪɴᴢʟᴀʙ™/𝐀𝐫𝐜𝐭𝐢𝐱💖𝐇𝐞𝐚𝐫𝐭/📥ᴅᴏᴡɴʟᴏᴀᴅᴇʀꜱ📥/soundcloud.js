...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _soundcloud link_`,
            ...
            ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
            yield ScrapperClient.getSongInfo(ǟʀɢʊʍɛռȶ[0]).then((song) => __awaiter(this, void 0, void 0, function* () {
                Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `💡𝐈𝐧𝐟𝐨: In order to use this command:
...
⚡ 𝗚𝗲𝗻𝗿𝗲: ${song.genre}
🔗 𝐋𝐢𝐧𝐤: ${song.trackURL}
📜 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${song.description}`, song.thumbnail);
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                ...
                writer.on("finish", (error) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield client
                        .sendMessage(AʀƈȶɨӼ.chatId, fs.readFileSync(FFmpegFile), message_type_1.MessageType.audio, { quoted: Fox, mimetype: "audio/mp4" })
