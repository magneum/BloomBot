...
const DMedia = (TUF, Fox, ǟʀɢʊʍɛռȶ, Vʟӄʏʀɛ, FileID, FileSocket) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const FileName = "./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/" + FileID + ".png";
        ...
        if (Vʟӄʏʀɛ.type === "image" || Vʟӄʏʀɛ.isReplyImage) {
            ...
            yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `🔗𝐔𝐫𝐥: ${util.format(gotTgh)}`, FileName);
