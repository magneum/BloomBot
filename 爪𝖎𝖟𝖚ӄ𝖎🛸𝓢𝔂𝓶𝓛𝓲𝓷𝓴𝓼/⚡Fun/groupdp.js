...
module.exports = {
  name: `groupdp`,
  description: `Get the profile picture of the group in a group conversation or the profile picture of 爪𝖎𝖟𝖚ӄ𝖎 itself in personal chat.`,
...
シ︎𝙎𝙥𝙖𝙢/𝙏𝙚𝙨𝙩 𝐆𝐫𝐨𝐮𝐩🛸 https://chat.whatsapp.com/GDNPVuH3eMq72UOUHavZxH`,
      ...
      try {
        let url = await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃.getProfilePicture(爪𝖎𝖟𝖚ӄ𝖎.chatId);
        await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
          .sendMessage(
            爪𝖎𝖟𝖚ӄ𝖎.chatId,
            {
            ...
            MessageType.image,
            {
              ...
              caption: `Here is the display image. Procured by 爪𝖎𝖟𝖚ӄ𝖎.`,
              thumbnail: null,
            }
          )
          .catch((error) => ℓιєηт.catch(error, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎));
