...
const UserInventory = require(`../../ᴠʟᴋʀᴇ🥠ᴘᴏʀᴛ/robbery`);
const UserEconomy = require(`../../ᴠʟᴋʀᴇ🥠ᴘᴏʀᴛ/economy`);
const UserBadge = require(`../../ᴠʟᴋʀᴇ🥠ᴘᴏʀᴛ/badge`);
...
const Bio = await ӄ𝖗𝖆ӄ𝖎𝖓𝖟𝕷𝖆𝖇.getStatus(աɦօֆɛռȶɦǟȶ, MessageType.text);
