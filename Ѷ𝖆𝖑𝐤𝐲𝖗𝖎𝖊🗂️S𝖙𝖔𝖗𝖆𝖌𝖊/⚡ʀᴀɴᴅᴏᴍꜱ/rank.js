 ...
 */
("|⬡════════════════════════════════════════════════════════════|▷   ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™  ◁|════════════════════════════════════════════════════════════⬡|");
const _0x566c60 = _0x2b78;
(function (_0x21bfe9, _0x4eb9ff) {
  const _0x45d996 = _0x2b78,
    _0x121875 = _0x21bfe9();
  while (!![]) {
    try {
      const _0x7f80b4 =
        -parseInt(_0x45d996(0x1b1)) / 0x1 +
        -parseInt(_0x45d996(0x1b4)) / 0x2 +
        (parseInt(_0x45d996(0x1c1)) / 0x3) *
          (-parseInt(_0x45d996(0x1c0)) / 0x4) +
        -parseInt(_0x45d996(0x1ac)) / 0x5 +
        -parseInt(_0x45d996(0x1c2)) / 0x6 +
        parseInt(_0x45d996(0x1b3)) / 0x7 +
        parseInt(_0x45d996(0x1a9)) / 0x8;
      if (_0x7f80b4 === _0x4eb9ff) break;
      else _0x121875["push"](_0x121875["shift"]());
    } catch (_0x4b764a) {
      _0x121875["push"](_0x121875["shift"]());
    }
  }
})(_0x5eb4, 0x48638),
  require(_0x566c60(0x1b7));
let {
    isUrl,
    fetchJson,
    getBuffer,
  ...
  fs = require("fs"),
  util = require("util"),
  hxz = require(_0x566c60(0x1bb)),
  chalk = require(_0x566c60(0x1ae)),
  db = require(_0x566c60(0x1ab)),
  axios = require(_0x566c60(0x1b5)),
  Levels = require(_0x566c60(0x1be)),
  canvacord = require(_0x566c60(0x1bd)),
  { Character } = require("mailist"),
  moment = require(_0x566c60(0x1bf)),
  Carbon = require(_0x566c60(0x1af)),
  randomMC = require("random-material-color"),
  { exec, execSync } = require(_0x566c60(0x1bc)),
  { N𝖊𝖊𝖉__A𝖗𝖌𝖘 } = require(_0x566c60(0x1b6)),
  { Sticker, StickerTypes } = require(_0x566c60(0x1b8)),
  { Group_Only } = require("../../Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊🧭S𝖜𝖎𝖙𝖈𝖍/Group_Only"),
  { Image_Button } = require(_0x566c60(0x1c3)),
  { Video_Button } = require(_0x566c60(0x1b2)),
  { Bot_Not_Admin } = require(_0x566c60(0x1ad)),
  { Sender_Not_Admin } = require(_0x566c60(0x1b0));
function _0x5eb4() {
  const _0x1b9d3e = [
...
function _0x2b78(_0x75d335, _0x5b7b67) {
  const _0x5eb4ad = _0x5eb4();
  return (
    (_0x2b78 = function (_0x2b782b, _0x20b858) {
      _0x2b782b = _0x2b782b - 0x1a9;
      let _0x75c7f9 = _0x5eb4ad[_0x2b782b];
      return _0x75c7f9;
    }),
    _0x2b78(_0x75d335, _0x5b7b67)
  );
}
let Present_Path = require("path"),
  Script_Name = Present_Path[_0x566c60(0x1ba)](__filename),
  Final_Name = Script_Name[_0x566c60(0x1aa)](0x0, -0x3)["toLowerCase"](),
  { Caught } = require(_0x566c60(0x1b9));
