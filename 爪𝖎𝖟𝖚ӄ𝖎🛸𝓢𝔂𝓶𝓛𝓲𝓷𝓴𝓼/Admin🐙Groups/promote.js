...
const { getCleanedContact } = require(`../../爪𝖎𝖟𝖚ӄ𝖎🧀𝓒𝓻𝓪𝓽𝓮/getCleanedContact`);
const { isMember } = require(`../../爪𝖎𝖟𝖚ӄ𝖎🧀𝓒𝓻𝓪𝓽𝓮/isMember`);
...
シ︎𝙎𝙥𝙖𝙢/𝙏𝙚𝙨𝙩 𝐆𝐫𝐨𝐮𝐩🛸 https://chat.whatsapp.com/GDNPVuH3eMq72UOUHavZxH`,
    ...
    try {
      ...
      if (!爪𝖎𝖟𝖚ӄ𝖎.isReply && typeof arg[0] == `undefined`) {
        𝓚𝓻𝓪𝓴𝓲𝓷𝔃
          .sendMessage(
            爪𝖎𝖟𝖚ӄ𝖎.chatId,
      ...
      if (爪𝖎𝖟𝖚ӄ𝖎.isReply) {
        ...
        var contact = await getCleanedContact(arg, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎);
      }

      var admin = false;
      var CheckMember = await isMember(contact, 爪𝖎𝖟𝖚ӄ𝖎.groupMembers);
      for (const index in 爪𝖎𝖟𝖚ӄ𝖎.groupMembers) {
        if (contact == 爪𝖎𝖟𝖚ӄ𝖎.groupMembers[index].jid.split(`@`)[0]) {
          if (爪𝖎𝖟𝖚ӄ𝖎.groupMembers[index].isAdmin) {
            admin = true;
          }
        }
      }
      if (CheckMember) {
        if (!admin == true) {
          ...
          𝓚𝓻𝓪𝓴𝓲𝓷𝔃.groupMakeAdmin(爪𝖎𝖟𝖚ӄ𝖎.chatId, arr);
          𝓚𝓻𝓪𝓴𝓲𝓷𝔃
            .sendMessage(
              爪𝖎𝖟𝖚ӄ𝖎.chatId,
