...
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("💤 𝐂𝐨𝐦𝐦𝐚𝐧𝐝: "), Glaucous(Vlkyre.commandName || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("🧛🏽‍♂️ 𝐒𝐞𝐧𝐝𝐞𝐫: "), Burgundy(Vlkyre.sender || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("🧛🏽‍♂️ 𝐒𝐞𝐧𝐝𝐞𝐫𝐍𝐚𝐦𝐞: "), Gamboge(Vlkyre.pushName || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("❗ 𝐒𝐞𝐧𝐝𝐞𝐫 𝐀𝐝𝐦𝐢𝐧: "), Vermilion(Vlkyre.isSenderAdmin || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("⚡ 𝐒𝐞𝐧𝐝𝐞𝐫 𝐓𝐔𝐅: "), Vermilion(Vlkyre.isSenderTUF || "")));
...
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("💤 𝐂𝐨𝐦𝐦𝐚𝐧𝐝: "), ӄօʟօʀ["default"].bgBlue(Vlkyre.commandName || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("🧛🏽‍♂️ 𝐒𝐞𝐧𝐝𝐞𝐫: "), ӄօʟօʀ["default"].bgRed(Vlkyre.sender || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("🧛🏽‍♂️ 𝐒𝐞𝐧𝐝𝐞𝐫𝐍𝐚𝐦𝐞: "), ӄօʟօʀ["default"].bgMagenta(Vlkyre.pushName || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("❗ 𝐒𝐞𝐧𝐝𝐞𝐫 𝐀𝐝𝐦𝐢𝐧: "), ӄօʟօʀ["default"].bgYellow(Vlkyre.isSenderAdmin || "")));
console.log(ӄօʟօʀ["default"].black(ӄօʟօʀ["default"].bgWhite("⚡ 𝐒𝐞𝐧𝐝𝐞𝐫 𝐓𝐔𝐅: "), ӄօʟօʀ["default"].bgYellow(Vlkyre.isSenderTUF || "")));
