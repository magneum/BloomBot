...
let ProTon = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🌗E𝖛𝖊𝖓𝖙𝖘/ProTon");
let { ytaR } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🖋️L𝖎𝖇𝖗𝖆𝖗ყ/y2mate");
let { ARanks } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🛩️𝕿𝖞𝖕𝖊𝖘/ARanks");
let { Caught } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🌀B𝖚𝖙𝖙𝖔𝖓𝖘/Caught");
let { DenyLink } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🛩️𝕿𝖞𝖕𝖊𝖘/DenyLink");
let { getBuffer } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🖋️L𝖎𝖇𝖗𝖆𝖗ყ/ɴᴇᴄᴛᴏʀ");
let Radio = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🧆𝕯𝖆𝖙𝖆𝖇𝖆𝖘𝖊/🍃𝖒𝖔𝖓𝖌𝖔/radio");
let { 𝕮𝖆𝖘𝖊𝕮𝖎𝖗𝖈𝖚𝖎𝖙 } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊📮W𝖆𝖗𝖉𝖗𝖔𝖇𝖊/𝕮𝖆𝖘𝖊𝕮𝖎𝖗𝖈𝖚𝖎𝖙");
...
let { Message_NotMe } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊📮W𝖆𝖗𝖉𝖗𝖔𝖇𝖊/Message_NotMe");
`|⬡═════════════════════════════════════════════════════════════════════|▷ 𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 ◁|═════════════════════════════════════════════════════════════════════⬡|`;
exports.ᴘᴏᴡᴇʀ = async (Ѷ𝖎𝖔𝖓, 𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊) => {
if (Ѷ𝖑𝐤𝐲𝖗𝖊.chatID === "120363024362806300@g.us") {
return await Req(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊);
}
...
return await ɴᴇᴡᴜꜱᴇʀᴄ.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊, 𝕰𝖗𝖗𝖔𝖗));
} else {
ꜱᴇʀᴄ.Total = ꜱᴇʀᴄ.Total + Ѷ𝖎𝖔𝖓𝖒𝖔𝖓𝖌𝖔;
ꜱᴇʀᴄ.LastTime = Date.now();
await ꜱᴇʀᴄ.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊, 𝕰𝖗𝖗𝖔𝖗));
let ᴍꜱᴇᴄ = require("parse-ms");
...
return await newRadio.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊, 𝕰𝖗𝖗𝖔𝖗));
} else {
...
await uR.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊, 𝕰𝖗𝖗𝖔𝖗));
// console.log(
...
// return await 𝖍𝖆𝖜ӄ.sendMessage(Ѷ𝖑𝐤𝐲𝖗𝖊.chatID, {
// audio: { url: DLoader },
// contextInfo: {
// externalAdReply: {
...
`|⬡═════════════════════════════════════════════════════════════════════|▷ 𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 ◁|═════════════════════════════════════════════════════════════════════⬡|`;
if (Ѷ𝖑𝐤𝐲𝖗𝖊.message && !Ѷ𝖑𝐤𝐲𝖗𝖊.fromMe) {
await Message_NotMe(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊);
}
if (Ѷ𝖑𝐤𝐲𝖗𝖊.message) {
...
if (𝕰𝖗𝖗𝖔𝖗) return Caught(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊, 𝕰𝖗𝖗𝖔𝖗);
if (!userRank) return;
await ARanks(Ѷ𝖑𝐤𝐲𝖗𝖊, 𝖍𝖆𝖜ӄ, Caught, Ѷ𝖑𝐤𝐲𝖗𝖊.A𝖗𝖌𝖘);
}
);
}
await ProTon.Vprtn(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊);
`|⬡═════════════════════════════════════════════════════════════════════|▷ 𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 ◁|═════════════════════════════════════════════════════════════════════⬡|`;
if (
Ѷ𝖑𝐤𝐲𝖗𝖊.message &&
...
!Ѷ𝖑𝐤𝐲𝖗𝖊.fromMe &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.isSenderTUF &&
Ѷ𝖑𝐤𝐲𝖗𝖊.groupMetadata.subject.includes("𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭")
) {
...
if (𝕰𝖗𝖗𝖔𝖗) return console.log(𝕰𝖗𝖗𝖔𝖗);
if (userBCheck && !Ѷ𝖑𝐤𝐲𝖗𝖊.fromMe && !Ѷ𝖑𝐤𝐲𝖗𝖊.isSenderTUF) {
return;
} else if (userGCheck && !Ѷ𝖑𝐤𝐲𝖗𝖊.fromMe && !Ѷ𝖑𝐤𝐲𝖗𝖊.isSenderTUF) {
return;
} else {
if (Ѷ𝖑𝐤𝐲𝖗𝖊.isCommand) {
let { ӄօʟօʀs } = require("../Ѷ𝖑𝐤𝐲𝖗𝖊🌗E𝖛𝖊𝖓𝖙𝖘/ӄօʟօʀs");
await ӄօʟօʀs(𝖍𝖆𝖜ӄ, Ѷ𝖑𝐤𝐲𝖗𝖊);
`|⬡═════════════════════════════════════════════════════════════════════|▷ 𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 ◁|═════════════════════════════════════════════════════════════════════⬡|`;
let MeA = [];
let MeB = [];
let MeC = [];
...
Ѷ𝖑𝐤𝐲𝖗𝖊.isCommand &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.isSenderTUF &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.Body.includes("how") &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.Body.includes("help") &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.Body.includes("menu") &&
!Ѷ𝖑𝐤𝐲𝖗𝖊.Body.includes("support") &&
!MeA.includes(Ѷ𝖑𝐤𝐲𝖗𝖊.sender) &&
!MeB.includes(Ѷ𝖑𝐤𝐲𝖗𝖊.sender) &&
!MeC.includes(Ѷ𝖑𝐤𝐲𝖗𝖊.sender) &&
