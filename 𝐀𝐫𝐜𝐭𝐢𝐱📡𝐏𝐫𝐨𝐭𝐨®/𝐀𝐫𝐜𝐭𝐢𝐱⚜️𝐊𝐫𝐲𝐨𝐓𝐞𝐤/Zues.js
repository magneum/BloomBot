...
⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
*/
const getCleanedContact = (ǟʀɢʊʍɛռȶ, TUF, AʀƈȶɨӼ) => __awaiter(void 0, void 0, void 0, function* () {
    var jidNumber = "";
    ...
    if (parseInt(ǟʀɢʊʍɛռȶ[0]) === NaN || ǟʀɢʊʍɛռȶ[0][0] === "+" || ǟʀɢʊʍɛռȶ[0][0] === "@") {
        if (ǟʀɢʊʍɛռȶ[0][0] === "@" || ǟʀɢʊʍɛռȶ[0][0] === "+") {
            ...
            TUF.sendMessage(AʀƈȶɨӼ.chatId, "*Enter valid contact number.* Approved Syntax:\n```1. XXXXXXXXXX``` \n```2. Tag the person``` \n```3. +(YYY)XXXXXXXXXX.``` \n_(YY- Country Code, without zeros)_", message_type_1.MessageType.text);
            return undefined;
        }
    }
    else {
...
⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
*/
const handleError = (err, TUF, AʀƈȶɨӼ, customMessage = "```Something went wrong. The error has been logged in log chats```") => __awaiter(void 0, void 0, void 0, function* () {
