...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _gif name_`,
                                    },
                                ],
                            },
                        ],
...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _gif name_`,
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                let url = `https://api.tenor.com/v1/search?q=${args.join(" ")}&key=${______1.default.Ten}&limit=100`;
