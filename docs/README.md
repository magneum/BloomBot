...
[![NPM](https://nodei.co/npm/Foxbot.png?downloads=true&downloadRank=true&stars=true)](https://nodei.co/npm/Foxbot)

[![npm version](https://badge.fury.io/js/Foxbot.svg)](https://badge.fury.io/js/Foxbot/)
...
```
Foxbot is in no way affiliated with, authorized, maintained,
