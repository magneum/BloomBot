        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const AudioSender = (fid, replyChat) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield saveBuffer(FileName, stream).then(() => Filter_Media_1.default.VFmedia(TUF, Fox, AʀƈȶɨӼ, FileName, ConvertedName, `-af "aresample=48000,asetrate=48000*1.25"`));
                });
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                if (AʀƈȶɨӼ.isReplyAudio) {
                    ...
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _reply to any audio in the chat_`, dotScrpt);
                }
            }
            catch (error) {
