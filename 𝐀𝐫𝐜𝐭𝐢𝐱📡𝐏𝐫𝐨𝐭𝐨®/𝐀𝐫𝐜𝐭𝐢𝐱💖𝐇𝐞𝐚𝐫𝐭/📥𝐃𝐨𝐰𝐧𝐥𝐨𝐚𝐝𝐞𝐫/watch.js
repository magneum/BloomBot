...
//" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
const TubeVideo = require("../../𝐀𝐫𝐜𝐭𝐢𝐱💽𝐌𝐞𝐝𝐢𝐚/TubeVideo");
...
Option 2 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _youtube link_`, dotScrpt);
            ...
            if (!LinkFound) {
                Text_List_1.default.VText(TUF, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: No Video Found!`);
                return;
            }
            //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
            var TubeFile = LinkFound.videos.slice(0, 1);
            TubeFile.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (Found.seconds > 1800) {
                        Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Audio less then 30mins!_

⭕️𝐘𝐨𝐮𝐓𝐮𝐛𝐞 𝐀𝐈: ${Found.title}
🍻𝐓𝐢𝐭𝐥𝐞: ${Found.title}
⏰𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧: ${Found.timestamp}`, Found.thumbnail);
                    }
                    return yield TubeVideo.VTvdo(TUF, Fox, AʀƈȶɨӼ, Found);
                });
            });
        });
    },
