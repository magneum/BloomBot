...
⪢ ʏᴏᴜᴛᴜʙᴇ⭕ʏᴏᴜᴛᴜʙᴇ ᴍᴜꜱɪᴄ`;
        ...
        ffmpeg(stream)
          .audioBitrate(320)
          .toFormat(`ipod`)
          .saveToFile(`./爪𝖎𝖟𝖚ӄ𝖎6🗑️𝓑𝓲𝓷/${chat.key.id}.mp3`)
          .on(`end`, async () => {
            await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
              .sendMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, `Uploading song...`, MessageType.text)
              .catch((cᴇʀʀᴏʀ) => {
                ℓιєηт.catch((cᴇʀʀᴏʀ, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎6));
              });
            await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
              .sendMessage(
                爪𝖎𝖟𝖚ӄ𝖎6.chatId,
                fs.readFileSync(`./爪𝖎𝖟𝖚ӄ𝖎6🗑️𝓑𝓲𝓷/${chat.key.id}.mp3`),
                MessageType.audio,
                {
            ...
            fs.unlink(`./爪𝖎𝖟𝖚ӄ𝖎6🗑️𝓑𝓲𝓷/${chat.key.id}.mp3`, (cᴇʀʀᴏʀ) => {
        ...
        await ℓιєηт.catch((cᴇʀʀᴏʀ, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎6));
      }
    }
  },
};
