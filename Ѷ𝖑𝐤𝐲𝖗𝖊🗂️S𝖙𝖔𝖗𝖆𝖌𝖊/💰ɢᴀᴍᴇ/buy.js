...
let Robbery = require(`../../Ѷ𝖑𝐤𝐲𝖗𝖊🧆𝕯𝖆𝖙𝖆𝖇𝖆𝖘𝖊/🍃𝖒𝖔𝖓𝖌𝖔/robbery`);
...
async (Èrrðr, userEco) => {
if (Èrrðr) return Caught(ӄ𝖗𝖞ӄ𝖓𝖟, Ѷ𝖑𝐤𝐲𝖗𝖊, util.format(Èrrðr));
if (!userEco) {
...
await newUser
.save()
.catch((Èrrðr) => Caught(ӄ𝖗𝖞ӄ𝖓𝖟, Ѷ𝖑𝐤𝐲𝖗𝖊, util.format(Èrrðr)));
...
.save()
.catch((Èrrðr) =>
Caught(ӄ𝖗𝖞ӄ𝖓𝖟, Ѷ𝖑𝐤𝐲𝖗𝖊, util.format(Èrrðr))
);
await userRob
.save()
.catch((Èrrðr) =>
