...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _text_`,
                ...
                */
                try {
                    yield Google({ query: ǟʀɢʊʍɛռȶ.join(" ") }).then((results) => __awaiter(this, void 0, void 0, function* () {
                        let Googled = results.map(({ title, link, snippet }) => {
                            return `🍻 𝐓𝐢𝐭𝐥𝐞: ${title}\n🔗 𝐋𝐢𝐧𝐤: ${link}\n📜 𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${snippet}`;
                        }).join `\n\n`;
                        return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `𝐆𝐨𝐨𝐠𝐥𝐞🔎𝐀𝐏𝐈

${Googled}`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                    }));
                }
                catch (error) {
