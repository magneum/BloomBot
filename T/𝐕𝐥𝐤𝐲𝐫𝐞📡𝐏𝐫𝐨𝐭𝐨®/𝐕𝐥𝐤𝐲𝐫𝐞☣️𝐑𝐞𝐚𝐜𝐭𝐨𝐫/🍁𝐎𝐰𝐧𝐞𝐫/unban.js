        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!Vʟӄʏʀɛ.fromMe && !Vʟӄʏʀɛ.isSenderMOD) {
                    return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌𝐃𝐞𝐧𝐢𝐞𝐝: _Owner/Dev Only.You Are Not Allowed!_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                }
                // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                if (Vʟӄʏʀɛ.isGroup && !Vʟӄʏʀɛ.isTextReply) {
                    ...
                    yield Ban.findOne({
                        ...
                        if (error) {
                            Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error);
                            return;
                        }
                        if (!userBan) {
                            return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${groupData.subject}* Was Not Banned!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                        }
                        else {
                            yield userBan
                                .delete()
                                .catch((error) => Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                            return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${groupData.subject}* Has Been Un-Banned!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                        }
                    }));
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                    ...
                    Ban.findOne({
                        ...
                        if (!userBan) {
                            return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${քɛʀֆօռɢօȶռʊʍ}* Was Not Banned!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                        }
                        else {
                            yield userBan
                                .delete()
                                .catch((error) => Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                            return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${քɛʀֆօռɢօȶռʊʍ}* Has Been Un-Banned!`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                        }
                    }));
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - _reply to person to un-ban_: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}
Option 2 - _don't reply to anyone and group will be un-banned_: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}`, dotScrpt);
                }
                // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
            }
            catch (error) {
