...
╚════════════╝`,
      ...
      if (ֆǟӄʊʀǟ.isCmd) {
        ...
        if (CheckBans === true && !ֆǟӄʊʀǟ.fromMe && !ֆǟӄʊʀǟ.isSenderDev) {
          console.log(
            "═══════════════| 🔻Banned Group/user🔻 |═══════════════"
          );
          return;
...
╔════| 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™
║💡INFO ⬰ New Updates Pending. Auto Updating...
╚════════════╝`
                );
                console.log(
...
╚════════════╝`
        ...
        const gMetadataa = await ӄʀǟӄɨռʐ.groupMetadata("120363020792949649@g.us");
        let members = [];
        ...
        if (
          ...
          if (!members.includes(աɦօֆɛռȶɦǟȶ) && !memberss.includes(աɦօֆɛռȶɦǟȶ)) {
