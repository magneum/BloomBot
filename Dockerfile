...
RUN npm install n -g && n install 16 && hash -r && npm install yarn -g
...
RUN yarn add 𝕶𝖗𝖆𝖐𝖎𝖓𝖟𝕷𝖆𝖇/@DeTone___ && pip install -r ⭕𝖈𝖆𝖗𝖆.txt && npm install --force --save && rm package-lock.json && npm install -g spotify-dl spdl-core
