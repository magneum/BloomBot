...
const DareGet = JSON.parse(fs.readFileSync(`./Sakura🛰️Server/FISH/dare.json`));
const RandomTruth = TruthGet[Math.floor(Math.random() * TruthGet.length)];
const RandomDare = DareGet[Math.floor(Math.random() * DareGet.length)];
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
module.exports = {
name: newScpt,
ֆǟӄʊʀǟӄǟɨʐօ: `*${ᴋᴇɪ}${newScpt}* _number_

💡 _Put Any Number And Random *Truth/Dare Question* will come._`,
