    ...
    handle(client, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄʀʏȶɛӄ) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (AʀƈȶɨӼ.isSenderGroupAdmin) {
                yield client.sendMessage(AʀƈȶɨӼ.chatId, "You Are Admin Of This Group: 🔰", message_type_1.MessageType.text);
            }
            else if (AʀƈȶɨӼ.isSenderGroupAdmin && AʀƈȶɨӼ.isSenderTUFs) {
                yield client.sendMessage(AʀƈȶɨӼ.chatId, "You Are Admin+Tuf(dev tester): 👑+🔰", message_type_1.MessageType.text);
            }
            else if (!AʀƈȶɨӼ.isSenderGroupAdmin && AʀƈȶɨӼ.isSenderTUFs) {
                yield client.sendMessage(AʀƈȶɨӼ.chatId, "You Are Tuf(dev tester): 👑", message_type_1.MessageType.text);
            }
            else {
                yield client.sendMessage(AʀƈȶɨӼ.chatId, "You Are Normal User: 🐾", message_type_1.MessageType.text);
            }
            ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
