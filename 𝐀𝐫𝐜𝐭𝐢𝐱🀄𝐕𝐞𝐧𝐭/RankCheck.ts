...
const user = await Levels.fetch(AʀƈȶɨӼ.sender, AʀƈȶɨӼ.chatId, true);
if (!user) {
await Levels.createUser(AʀƈȶɨӼ.sender, AʀƈȶɨӼ.chatId);
await Levels.setLevel(AʀƈȶɨӼ.sender, AʀƈȶɨӼ.chatId, 1);
await Levels.setXp(AʀƈȶɨӼ.sender, AʀƈȶɨӼ.chatId, 1);
}
...
if (hasLeveledUp) {
let Img: any;
await Levels.setLevel(AʀƈȶɨӼ.sender, AʀƈȶɨӼ.chatId, user.level + 1);
try {
