...
const Reply_1 = __importDefault(require("../../\uD835\uDC15\uD835\uDC25\uD835\uDC24\uD835\uDC32\uD835\uDC2B\uD835\uDC1E\u26CF\uFE0F\uD835\uDC02\uD835\uDC1A\uD835\uDC2F\uD835\uDC1E/Reply"));
            ...
            try {
                ...
                */
                if (Vʟӄʏʀɛ.isTextReply) {
                    ...
                    if (Receiver === ʟɴᴀᴍᴇ) {
                        return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌𝐃𝐞𝐧𝐢𝐞𝐝: _Can't rob yourself_`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                    }
                    return yield Reply_1.default.VNrl(TUF, Fox, Vʟӄʏʀɛ);
                }
                else {
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `╔═══⬡
