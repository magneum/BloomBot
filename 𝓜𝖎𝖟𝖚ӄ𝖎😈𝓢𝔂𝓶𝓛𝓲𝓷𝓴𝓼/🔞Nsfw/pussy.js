...
module.exports = {
  ...
  async handle(ӄʀǟӄɨռʐ, chat, 𝓜𝖎𝖟𝖚ӄ𝖎, arg, 𝓜𝓲𝔃𝓾𝓴𝓲𝓢𝓲𝓽𝓻𝓮𝓹) {
    ...
    if (𝓜𝖎𝖟𝖚ӄ𝖎.isGroup && !𝓜𝖎𝖟𝖚ӄ𝖎.isSenderGroupAdmin) {
      ...
      const link = await akaneko.nsfw.pussy();
      console.log(link);
      const downloader = await new Downloader({
        url: link,
        directory: `./𝓜𝖎𝖟𝖚ӄ𝖎🗑️𝓑𝓲𝓷`,
        fileName: `pussy_${ꜱᴇɴᴅᴇʀɪᴅ}.png`,
        cloneFiles: false,
      });
      try {
        await downloader.download();
        let content = fs.readFileSync(`./𝓜𝖎𝖟𝖚ӄ𝖎🗑️𝓑𝓲𝓷/pussy_${ꜱᴇɴᴅᴇʀɪᴅ}.png`);
        console.log(content);
        const media = await ӄʀǟӄɨռʐ.prepareMessage(
          𝓜𝖎𝖟𝖚ӄ𝖎.chatId,
          content,
...
🔗𝐋𝐢𝐧𝐤: ${link}`,
              ...
              buttons: [
                {
                  buttonId: `${ᴋᴇɪ}pussy`,
                  buttonText: { displayText: `${ᴋᴇɪ}pussy` },
                  type: 1,
                },
              ],
              headerType: 4,
