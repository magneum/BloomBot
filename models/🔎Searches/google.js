...
> _${WhatsBot.prefix}${finalname} manga-name_`
    ...
    var Googled = await WhatsBot.google({ query: WhatsBot.args.join(" ") });
    var Gxt = `*🔎Searched:* ${WhatsBot.args.join(" ")}`;
=======
> _${voxbot.prefix}${finalname} manga-name_`
      );
    }

    var Googled = await voxbot.google({ query: voxbot.args.join(" ") });
    var Gxt = `*🔎Searched:* ${voxbot.args.join(" ")}`;
>>>>>>> 17f52fe472c04e519779246ebe3026ed85ef536a
