...
const UserInventory = require(`../../ᴄᴏʀʟᴇxᴀ🍃Goose/robbery`);
const UserEconomy = require(`../../ᴄᴏʀʟᴇxᴀ🍃Goose/economy`);
const UserBadge = require(`../../ᴄᴏʀʟᴇxᴀ🍃Goose/badge`);
...
║🍊 𝗕𝗮𝗻𝗸 𝗕𝗮𝗹𝗮𝗻𝗰𝗲: ${userEco.money}
║🍋 𝗗𝗮𝗶𝗹𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝗟𝗲𝗳𝘁: ${UBadge.Limits}
║🥝 𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗚𝗿𝗼𝘂𝗽: ${groupDataRank.subject}
