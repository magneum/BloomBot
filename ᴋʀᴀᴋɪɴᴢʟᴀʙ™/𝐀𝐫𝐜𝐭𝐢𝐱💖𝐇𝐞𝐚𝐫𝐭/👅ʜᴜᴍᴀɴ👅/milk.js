    ...
    handle(client, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄʀʏȶɛӄ) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                yield got(`https://www.reddit.com/r/lactating/random.json`).then((newScpt) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!amazeme.endsWith(`.png`) &&
                        ...
                        var amazeme = yield got(`https://www.reddit.com/r/lactating/random.json`).then((newScpt) => __awaiter(this, void 0, void 0, function* () {
                            var file = JSON.parse(newScpt.body);
                            var title = file[0].data.children[0].data.title;
                            var amazeme = file[0].data.children[0].data.url;
                            return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `👅 𝐓𝐨𝐩𝐢𝐜: ${title}`, amazeme);
                        }));
                        ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                    }
                        ...
                        try {
                            ...
                            ffmpeg(`${__dirname}/${Date.now()}_${ꜰɪɴᴀᴍᴇ}.gif`)
                                ...
                                yield Video_Button_1.default.VVid(client, Fox, AʀƈȶɨӼ, `👅 𝐓𝐨𝐩𝐢𝐜: ${title}`, `${__dirname}/${Date.now()}_${ꜰɪɴᴀᴍᴇ}.mp4`);
