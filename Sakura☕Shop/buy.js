...
╚════════════╝`
      ...
      `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
      if (!RobCatelog.includes(Needs[0]) && !BadgeCatelog.includes(Needs[0])) {
        var 𝓜Usage = ꜱɪᴛʀᴀᴘ.get(ֆǟӄʊʀǟ.commandName);
        var ᴍɪᴢᴜᴋɪᴍᴏʀᴇ =
          𝓜Usage.ֆǟӄʊʀǟӄǟɨʐօ === undefined ? `Null` : 𝓜Usage.ֆǟӄʊʀǟӄǟɨʐօ;
        const ᴀʀɢᴜᴍᴇɴᴛ = require(`../../Sakura🛰️Server/ɴᴇᴇᴅᴀʀɢᴜᴍᴇɴᴛ`);
...
╔══◇║🔱𝐂𝐨𝐦𝐦𝐚𝐧𝐝: _${ᴋᴇɪ}${FinalName}_
║
║❌ 𝗘𝗿𝗿𝗼𝗿: _Just Opened Your Account!_
...
╚════════════╝`
                    ...
                    `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
                    if (userEco.money > ItemRobPrice && ItemRob === "padlock") {
                      userRob.padlock = 1;
...
╚════════════╝`
                    ...
                    `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
                    if (userEco.money > ItemRobPrice && ItemRob === "laptop") {
                      userRob.laptop = 1;
                      userEco.money = userEco.money - ItemRobPrice;
                      await userRob
                        .save()
...
╚════════════╝`
                    ...
                    `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
                    if (userEco.money > ItemRobPrice && ItemRob === "charm") {
                      userRob.charm = 1;
                      userEco.money = userEco.money - ItemRobPrice;
                      await userRob
                        .save()
...
╚════════════╝`
                    ...
                    `|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🍹𝐒𝐚𝐤𝐮𝐫𝐚𝐁𝐨𝐭(𝐜) |════════════════════════════════════════════⬡|`;
                    if (userEco.money > ItemRobPrice && ItemRob === "sword") {
                      userRob.sword = 1;
                      userEco.money = userEco.money - ItemRobPrice;
                      await userRob
                        .save()
...
╚════════════╝`
      ...
      if (BadgeCatelog.includes(Needs[0])) {
