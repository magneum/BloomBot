...
const messages_upsert = (m, ӄʀʏȶɛӄ, commandHandler) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let client = new client_1.default(ӄʀʏȶɛӄ);
    if (AʀƈȶɨӼ.isCmd) {
        console.log(AʀƈȶɨӼ);
        console.log(chalk_1.default.red(`💡𝐈𝐧𝐟𝐨꧂  ${AʀƈȶɨӼ.commandName} command executed.`));
        ...
        const gMetadata1 = yield ӄʀʏȶɛӄ.groupMetadata(AʀƈȶɨӼ.chatId);
        ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
        if (!command) {
