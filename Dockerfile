...
python3-pip \
python-is-python3
RUN git clone --branch Railwar-For-v4 https://github.com/KryKenz/Vlkyre
...
RUN cd Vlkyre
WORKDIR /Vlkyre
RUN git init --initial-branch=Railwar-For-v4 && git fetch origin Railwar-For-v4 && git reset --hard origin/Railwar-For-v4
