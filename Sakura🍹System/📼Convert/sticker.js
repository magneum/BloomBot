...
module.exports = {
name: newScpt,
ֆǟӄʊʀǟӄǟɨʐօ: `Reply _${ᴋᴇɪ}sticker_ to _image_`,
...
//|🍹  ⬡===========================================|  𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™  |===========================================⬡  🍹|
let FileNameWebp = `${__dirname}/${ꜱᴇɴᴅᴇʀɪᴅ.toString()}.webp`;
let FileNameJpeg = `${__dirname}/${ꜱᴇɴᴅᴇʀɪᴅ.toString()}.jpeg`;
let FileNamePng = `${__dirname}/${ꜱᴇɴᴅᴇʀɪᴅ.toString()}.png`;
let FileNameMp4 = `${__dirname}/${ꜱᴇɴᴅᴇʀɪᴅ.toString()}.mp4`;
//|🍹  ⬡===========================================|  𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™  |===========================================⬡  🍹|
