        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_`, dotScrpt);
                }
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                if (!ǟʀɢʊʍɛռȶ) {
                    return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_`, dotScrpt);
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                try {
                    const searches = yield GeniusClient.songs.search(ǟʀɢʊʍɛռȶ.join(` `));
                    const GeniusSong = searches[0];
                    const Geniuslyrics = yield GeniusSong.lyrics();
                    return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `📜 𝗟𝘆𝗿𝗶𝗰𝘀 𝗙𝗼𝘂𝗻𝗱 𝗙𝗼𝗿: _${ǟʀɢʊʍɛռȶ.join(` `)}_
🎹 𝐓𝐢𝐭𝐥𝐞: ${GeniusSong.raw.title}
💡 𝗟𝘆𝗿𝗶𝗰𝘀 𝗦𝗼𝘂𝗿𝗰𝗲: _Genius-Lyrics_
🔗 𝗟𝘆𝗿𝗶𝗰𝘀 𝗨𝗿𝗹: ${GeniusSong.raw.url}

${Geniuslyrics}`, GeniusSong.raw.song_art_image_thumbnail_url);
                }
                catch (error) {
                    const lyricssong = yield Second_Try_Lyrics(ǟʀɢʊʍɛռȶ.join(` `));
                    return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `📜 𝗟𝘆𝗿𝗶𝗰𝘀 𝗙𝗼𝘂𝗻𝗱 𝗙𝗼𝗿: _${ǟʀɢʊʍɛռȶ.join(` `)}_
💡 𝗟𝘆𝗿𝗶𝗰𝘀 𝗦𝗼𝘂𝗿𝗰𝗲: ${lyricssong.source.name}
🔗 𝗟𝘆𝗿𝗶𝗰𝘀 𝗨𝗿𝗹: ${lyricssong.source.link}

${lyricssong.lyrics}`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ.png");
                }
            }
            catch (error) {
