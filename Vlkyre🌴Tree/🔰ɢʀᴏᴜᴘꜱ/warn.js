...
await userWarn.delete().catch((error) => ꜰᴜᴄᴋ.catch(error, ӄ𝖗𝖞ӄ𝖓𝖟, Vlkyre, KryChat));
await ӄ𝖗𝖞ӄ𝖓𝖟.groupRemove(Vlkyre.chatID, [RemoveTheSucker]).catch((error) => ꜰᴜᴄᴋ.catch(error, ӄ𝖗𝖞ӄ𝖓𝖟, Vlkyre, KryChat));
return;
}
("|⬡═══════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═══════════════════════════════════════════════════════════════⬡|");
...
await ӄ𝖗𝖞ӄ𝖓𝖟.sendMessage(Vlkyre.chatID, {text: `Kicked @${ʀᴇᴘʟɪᴇᴅ.split("@")[0]} successfuly `,contextInfo: { mentionedJid: [ʀᴇᴘʟɪᴇᴅ] },});
return await ӄ𝖗𝖞ӄ𝖓𝖟.groupParticipantsUpdate(Vlkyre.chatID,[ʀᴇᴘʟɪᴇᴅ],`remove`);
("|⬡═══════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═══════════════════════════════════════════════════════════════⬡|");
} else {
return await N𝖊𝖊𝖉__A𝖗𝖌𝖘(
ӄ𝖗𝖞ӄ𝖓𝖟,
