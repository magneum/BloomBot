...
𝕿𝖊𝖒𝖕.listen(8080, () => {
console.log(`🦋𝐀𝐫𝐜𝐭𝐢𝐱: Server Ready!`);
});
// http.createServer(function (req, res) {
// res.send(fs.readFileSync("./𝐀𝐫𝐜𝐭𝐢𝐱⌬𝐍𝐢𝐠𝐡𝐭𝐥𝐲.html"));
// res.end();
// })
// .listen(8080);
`|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|`;
