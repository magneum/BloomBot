    ...
    handle(TUF, Fox, Vʟӄʏʀɛ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ǟʀɢʊʍɛռȶ.length === 0) {
                return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_
...
Option 2 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _youtube link_`, dotScrpt);
            ...
            if (!LinkFound) {
                Text_List_1.default.VText(TUF, Fox, Vʟӄʏʀɛ, `❌𝗘𝗿𝗿𝗼𝗿: No Music Found!`);
                return;
            }
            // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
            ...
            Videos.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (Found.seconds > 1800) {
                        return Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Video less then 30mins!_
...
⏰𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧: ${Found.timestamp}`, Found.thumbnail);
                    ...
                    ffmpeg(FFmpegStream)
                        ...
                        yield ӄ𝖗𝖞ӄ𝖓𝖟.sendPresenceUpdate("recording", Vʟӄʏʀɛ.chatId);
                        yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `𝐘𝐨𝐮𝐓𝐮𝐛𝐞💿𝐅𝐢𝐥𝐭𝐞𝐫
...
📜𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${Found.description}`, Found.thumbnail);
                        // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                        require("child_process").exec(`ffmpeg -i ${FFmpegFile} -af "aresample=48000,asetrate=48000*1.25" ${FilteredAudio}`, (error) => __awaiter(this, void 0, void 0, function* () {
                            if (error) {
                                return Oops.VOp(TUF, Fox, Vʟӄʏʀɛ, error);
                            }
                            // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                            yield TUF
                                .sendMessage(Vʟӄʏʀɛ.chatId, fs.readFileSync(FilteredAudio), message_type_1.MessageType.audio, {
                                quoted: Fox,
                            })
