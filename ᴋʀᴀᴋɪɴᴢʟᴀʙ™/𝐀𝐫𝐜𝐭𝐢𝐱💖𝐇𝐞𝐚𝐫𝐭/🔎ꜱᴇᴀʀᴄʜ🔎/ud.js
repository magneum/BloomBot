        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic_`, dotScrpt);
                }
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                if (!ǟʀɢʊʍɛռȶ) {
                    return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic_`, dotScrpt);
                ...
                result.example = result.example.replace(/\]/g, `_`);
                return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `𝐔𝐫𝐛𝐚𝐧📙𝐃𝐢𝐜𝐭𝐢𝐨𝐧𝐚𝐫𝐲
🔎Word: ${result.word}
