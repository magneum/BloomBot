    ...
    handle(client, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄʀʏȶɛӄ) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ǟʀɢʊʍɛռȶ.length === 0) {
                return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _song name_
...
Option 2 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _youtube link_`, dotScrpt);
            ...
            if (!LinkFound) {
                Text_List_1.default.VText(client, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: No Music Found!`);
                return;
            }
            ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
            ...
            Videos.forEach(function (Found) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (Found.seconds > 1800) {
                        return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `❌𝗘𝗿𝗿𝗼𝗿: _Choose Smaller Video less then 30mins!_
...
⏰𝐃𝐮𝐫𝐚𝐭𝐢𝐨𝐧: ${Found.timestamp}`, Found.thumbnail);
                    ...
                    ffmpeg(FFmpegStream)
                        ...
                        yield Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `𝐘𝐨𝐮𝐓𝐮𝐛𝐞💿𝐅𝐢𝐥𝐭𝐞𝐫
...
📜𝐃𝐞𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧: ${Found.description}`, Found.thumbnail);
                        ...
                        require("child_process").exec(`ffmpeg -i ${FFmpegFile} -af "aresample=48000,asetrate=48000*1.25" ${FilteredAudio}`, (error) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                            yield client
                                .sendMessage(AʀƈȶɨӼ.chatId, fs.readFileSync(FilteredAudio), message_type_1.MessageType.audio, {
                                quoted: Fox,
                            })
