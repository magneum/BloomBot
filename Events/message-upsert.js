...
<br>
<mark class="red"><b></b>⌬</b></mark>To Check What Vlkyre Offers Just Join Any Below Groups and
Type #help.
<br>
<mark class="red"><b></b>⌬</b></mark>To Verify Youself Just Go Below and Check Frequently Asked
Section.
</p>
...
<h2 class="text-lg text-white font-medium title-font mb-4"> </h2>
<p class="leading-relaxed text-base"><b>❣️ User Name:</b><br>> <I>${gcName}</I></p>
<p class="leading-relaxed text-base"><b>📱 User Number:</b><br>> <I>${gcName}</I></p>
<p class="leading-relaxed text-base"><b>❓ Is User Admin:</b><br>> <I>${gcName}</I></p>
</div>
</div>
<div class="xl:w-1/4 md:w-1/2 p-4">
<div class="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
...
<h2 class="text-lg text-white font-medium title-font mb-4"> </h2>
<p class="leading-relaxed text-base"><b>🖊️ Command Executed:</b><br>> <I>${νℓкуяє.command}</I></p>
<p class="leading-relaxed text-base"><b>🍀 Message Body:</b><br>> <I>${νℓкуяє.budy || νℓкуяє.mtype}</I></p>
