...
async function ֆǟӄʊʀǟ() {
  ...
  try {
    ...
    console.log(
      Kolor.bgRed.black(
        `🍹INFO ⬰ 𝗦𝗮𝗸𝘂𝗿𝗮 𝗖𝗼𝗱𝗲 𝗜𝘀 𝗪𝗿𝗼𝗻𝗴. 𝗣𝗹𝗲𝗮𝘀𝗲 𝗥𝗲-𝗔𝘂𝘁𝗵 𝘂𝘀𝗶𝗻𝗴 𝘄𝗵𝗮𝘁𝘀𝗮𝗽𝗽!`
      )
    );
    process.exit(0);
  }
  ...
  ӄʀǟӄɨռʐ.on(`open`, async () => {
    console.log(
      Kolor.bgGreen.black(`🍹🍹ֆǟӄʊʀǟ™ 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 𝗧𝗼 𝗨𝘀𝗲𝗿-𝗪𝗵𝗮𝘁𝘀𝗮𝗽𝗽!✔️`)
    );
    console.log(
      Kolor.bgYellow.black(
        `⬡==========================⬡    🍹 ֆǟӄʊʀǟ™ 🍹    ⬡==========================⬡`
    ...
    console.log(
      Kolor.bgGreen.black(`🍹INFO ⬰ 𝐋𝐢𝐧𝐤𝐢𝐧𝐠 𝐒𝐚𝐤𝐮𝐫𝐚 𝐖𝐢𝐭𝐡 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞...✔️`)
    );
    try {
      ...
      await ֆǟӄʊʀǟsql
        .sync()
        .then(
          console.log(Kolor.bgYellow.black(`🍹INFO ⬰ 🍹ֆǟӄʊʀǟ™ Connected✔️`))
        );
    } catch (ℓαвєяяσя) {
      console.ℓαвєяяσя(
              ...
              .pull(async (ℓαвєяяσя, update) => {
                if (ℓαвєяяσя) {
                  try {
                    ...
                    console.log(
                      `Merge resulted in ${Kolor.bgRed.black(
                        ℓαвєяяσя
                      )} conflicts`
                    );
                  }
