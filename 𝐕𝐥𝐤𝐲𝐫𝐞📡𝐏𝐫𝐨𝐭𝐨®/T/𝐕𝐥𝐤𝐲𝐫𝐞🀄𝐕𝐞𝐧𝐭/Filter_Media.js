...
const Filter_Media = (TUF, Fox, Vʟӄʏʀɛ, FileName, ConvertedName, Filter) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        require("child_process").exec(`ffmpeg -i ${FileName} ${Filter} ${ConvertedName}`, () => __awaiter(void 0, void 0, void 0, function* () {
            yield TUF
                .sendMessage(Vʟӄʏʀɛ.chatId, fs.readFileSync(ConvertedName), message_type_1.MessageType.audio)
