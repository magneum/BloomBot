...
// ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
const Link_Proctectron = (TUF, Fox, Vʟӄʏʀɛ, ӄ𝖗𝖞ӄ𝖓𝖟) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (Vʟӄʏʀɛ.isGroup &&
            !Vʟӄʏʀɛ.fromMe &&
            !Vʟӄʏʀɛ.isSenderDev &&
            ...
            yield LinkList.findOne({
                ...
                if (!server)
                    return;
                let FetchCurrentGroupLink = yield ӄ𝖗𝖞ӄ𝖓𝖟.groupInviteCode(Vʟӄʏʀɛ.chatId);
...
🐾 Whatspp Invite Link
🐾 Discord Link
🐾 Telegram Link`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                    return yield ӄ𝖗𝖞ӄ𝖓𝖟
                        .groupRemove(Vʟӄʏʀɛ.chatId, [Vʟӄʏʀɛ.sender])
                        .catch((error) => console.log(error));
                    // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」        ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™    「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
                }
                else if (Vʟӄʏʀɛ.body.includes("https://t.me/") &&
