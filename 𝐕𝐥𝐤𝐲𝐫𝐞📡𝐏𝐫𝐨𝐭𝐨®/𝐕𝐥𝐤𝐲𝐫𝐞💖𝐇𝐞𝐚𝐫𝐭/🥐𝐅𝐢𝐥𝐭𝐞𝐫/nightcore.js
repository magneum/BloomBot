...
*/
`|⬡════════════════════════════════════════════|❝ Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|`;
const Filter_Media_1 = __importDefault(require("../../\uD835\uDC15\uD835\uDC25\uD835\uDC24\uD835\uDC32\uD835\uDC2B\uD835\uDC1E\uD83C\uDC04\uD835\uDC15\uD835\uDC1E\uD835\uDC27\uD835\uDC2D/Filter_Media"));
            ...
            try {
                ...
                */
                const AudioSender = (fid, replyChat) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const ConvertedName = `./${Date.now()}${fid}.mp3`;
                    const FileName = `./𝐕𝐥𝐤𝐲𝐫𝐞🐞𝐁𝐞𝐞𝐭𝐥𝐞/${fid}`;
                    const saveBuffer = (fileName, stream) => { var stream_1, stream_1_1; return __awaiter(this, void 0, void 0, function* () {
                        var e_1, _a;
                    ...
                    yield saveBuffer(FileName, stream).then(() => Filter_Media_1.default.VFmedia(TUF, Fox, Vʟӄʏʀɛ, FileName, ConvertedName, `-af "aresample=48000,asetrate=48000*1.25"`));
                });
                /*
                ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                ...
                */
                if (Vʟӄʏʀɛ.isReplyAudio) {
                    ...
                    var fid = Fox.message.extendedTextMessage.contextInfo.stanzaId;
                    yield AudioSender(fid, replyChatObject);
                    /*
                    ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                    「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」                                                                            「   𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®   」
                    ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                    */
                    ...
                    return FoxNeeded_1.default.VFox(TUF, Fox, Vʟӄʏʀɛ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _reply to any audio in the chat_`, dotScrpt);
                }
            }
            catch (error) {
