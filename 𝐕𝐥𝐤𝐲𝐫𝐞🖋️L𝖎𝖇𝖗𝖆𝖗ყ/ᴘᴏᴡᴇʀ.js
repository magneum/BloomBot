...
let ProTon = require("../𝐕𝐥𝐤𝐲𝐫𝐞🌗E𝖛𝖊𝖓𝖙𝖘/ProTon");
let { ytaR } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🖋️L𝖎𝖇𝖗𝖆𝖗ყ/y2mate");
let { ARanks } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🛩️𝕿𝖞𝖕𝖊𝖘/ARanks");
let { Caught } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🌀B𝖚𝖙𝖙𝖔𝖓𝖘/Caught");
let { DenyLink } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🛩️𝕿𝖞𝖕𝖊𝖘/DenyLink");
let { getBuffer } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🖋️L𝖎𝖇𝖗𝖆𝖗ყ/ɴᴇᴄᴛᴏʀ");
let Radio = require("../𝐕𝐥𝐤𝐲𝐫𝐞🧆𝕯𝖆𝖙𝖆𝖇𝖆𝖘𝖊/🍃𝖒𝖔𝖓𝖌𝖔/radio");
let { 𝕮𝖆𝖘𝖊𝕮𝖎𝖗𝖈𝖚𝖎𝖙 } = require("../𝐕𝐥𝐤𝐲𝐫𝐞📮W𝖆𝖗𝖉𝖗𝖔𝖇𝖊/𝕮𝖆𝖘𝖊𝕮𝖎𝖗𝖈𝖚𝖎𝖙");
...
let { Message_NotMe } = require("../𝐕𝐥𝐤𝐲𝐫𝐞📮W𝖆𝖗𝖉𝖗𝖔𝖇𝖊/Message_NotMe");
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
exports.ᴘᴏᴡᴇʀ = async (Ѷ𝖎𝖔𝖓, 𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞) => {
if (𝐕𝐥𝐤𝐲𝐫𝐞.chatID === "120363024362806300@g.us") {
return await Req(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞);
}
...
await ꜱᴇʀᴄ.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞, 𝕰𝖗𝖗𝖔𝖗));
let ᴍꜱᴇᴄ = require("parse-ms");
...
await uR.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞, 𝕰𝖗𝖗𝖔𝖗));
// console.log(
...
// return await 𝖍𝖆𝖜ӄ.sendMessage(𝐕𝐥𝐤𝐲𝐫𝐞.chatID, {
// audio: { url: DLoader },
// contextInfo: {
// externalAdReply: {
...
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
if (𝐕𝐥𝐤𝐲𝐫𝐞.message && !𝐕𝐥𝐤𝐲𝐫𝐞.fromMe) {
await Message_NotMe(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞);
}
if (𝐕𝐥𝐤𝐲𝐫𝐞.message) {
...
if (𝕰𝖗𝖗𝖔𝖗) return Caught(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞, 𝕰𝖗𝖗𝖔𝖗);
if (!userRank) return;
await ARanks(𝐕𝐥𝐤𝐲𝐫𝐞, 𝖍𝖆𝖜ӄ, Caught, 𝐕𝐥𝐤𝐲𝐫𝐞.A𝖗𝖌𝖘);
}
);
}
await ProTon.Vprtn(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞);
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
if (
𝐕𝐥𝐤𝐲𝐫𝐞.message &&
...
!𝐕𝐥𝐤𝐲𝐫𝐞.fromMe &&
!𝐕𝐥𝐤𝐲𝐫𝐞.isSenderTUF &&
𝐕𝐥𝐤𝐲𝐫𝐞.groupMetadata.subject.includes("𝐕𝐥𝐤𝐲𝐫𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭")
) {
...
if (𝕰𝖗𝖗𝖔𝖗) return console.log(𝕰𝖗𝖗𝖔𝖗);
if (userBCheck && !𝐕𝐥𝐤𝐲𝐫𝐞.fromMe && !𝐕𝐥𝐤𝐲𝐫𝐞.isSenderTUF) {
return;
} else if (userGCheck && !𝐕𝐥𝐤𝐲𝐫𝐞.fromMe && !𝐕𝐥𝐤𝐲𝐫𝐞.isSenderTUF) {
return;
} else {
if (𝐕𝐥𝐤𝐲𝐫𝐞.isCommand) {
let { ӄօʟօʀs } = require("../𝐕𝐥𝐤𝐲𝐫𝐞🌗E𝖛𝖊𝖓𝖙𝖘/ӄօʟօʀs");
await ӄօʟօʀs(𝖍𝖆𝖜ӄ, 𝐕𝐥𝐤𝐲𝐫𝐞);
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
let MeA = [];
let MeB = [];
let MeC = [];
...
𝐕𝐥𝐤𝐲𝐫𝐞.isCommand &&
!𝐕𝐥𝐤𝐲𝐫𝐞.isSenderTUF &&
!𝐕𝐥𝐤𝐲𝐫𝐞.Body.includes("how") &&
!𝐕𝐥𝐤𝐲𝐫𝐞.Body.includes("help") &&
!𝐕𝐥𝐤𝐲𝐫𝐞.Body.includes("menu") &&
!𝐕𝐥𝐤𝐲𝐫𝐞.Body.includes("support") &&
!MeA.includes(𝐕𝐥𝐤𝐲𝐫𝐞.sender) &&
!MeB.includes(𝐕𝐥𝐤𝐲𝐫𝐞.sender) &&
!MeC.includes(𝐕𝐥𝐤𝐲𝐫𝐞.sender) &&
!MeD.includes(𝐕𝐥𝐤𝐲𝐫𝐞.sender) &&
!MeE.includes(𝐕𝐥𝐤𝐲𝐫𝐞.sender)
) {
/*
...
*/
return await 𝐕𝐥𝐤𝐲𝐫𝐞.reply(`╔══『 𝐏𝐫𝐨𝐟𝐢𝐥𝐞𝐫® 』
║ *❣️ ɴᴀᴍᴇ:* ${𝐕𝐥𝐤𝐲𝐫𝐞.pushName || "No_Name"}
║ *⚡ ɪᴅ:* ${𝐕𝐥𝐤𝐲𝐫𝐞.chatID.split("@")[0]}
╚═══════╝
