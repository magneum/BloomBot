...
module.exports = {
  ...
  ULTƦONʍօʀɛ: `Obtain weather info by entering the city name.`,
        ...
        https.get(url, function (response) {
          ...
          response.on(`data`, function (data) {
            try {
              ...
              const imageUrl =
                `https://raw.githubusercontent.com/Prince-Mendiratta/ULTƦON-Resources/main/weather/` +
                imageName +
                `.jpg`;
