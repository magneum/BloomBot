...
module.exports = {
  ...
  async handle(ӄʀǟӄɨռʐ, chat, ֆǟӄʊʀǟ, Needs, ꜱɪᴛʀᴀᴘ, Clock, Ping) {
    try {
      ...
      hold.Hold(ֆǟӄʊʀǟ);
      let url = `https://api.tenor.com/v1/search?q=ugly&key=${_𝔏𝔞𝔟_.TEN}&limit=100`;
...
╔════◇🌿𝐓𝐨𝐩𝐢𝐜: ${FinalName}
║ 𝗨𝗴𝗹𝘆 𝗠𝗲𝗺𝗯𝗲𝗿: _@${personreceived}_
...
╔════◇🌿𝐓𝐨𝐩𝐢𝐜: ${FinalName}
║ 𝗨𝗴𝗹𝘆 𝗠𝗲𝗺𝗯𝗲𝗿: _Your Face Lmfao!_
╚════════════╝`,
            "https://i.postimg.cc/9Xkbbm7m/meme.png"
          );
        }
