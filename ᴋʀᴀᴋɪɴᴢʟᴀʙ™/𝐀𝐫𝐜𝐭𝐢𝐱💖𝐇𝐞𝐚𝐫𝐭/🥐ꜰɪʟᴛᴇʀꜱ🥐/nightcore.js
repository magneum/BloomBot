...
*/
`|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|`;
const Filter_Media_1 = __importDefault(require("../../\uD835\uDC00\uD835\uDC2B\uD835\uDC1C\uD835\uDC2D\uD835\uDC22\uD835\uDC31\uD83C\uDC04\uD835\uDC15\uD835\uDC1E\uD835\uDC27\uD835\uDC2D/Filter_Media"));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const AudioSender = (fid, replyChat) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const FileName = `./𝐀𝐫𝐜𝐭𝐢𝐱🐞𝐁𝐞𝐞𝐭𝐥𝐞/${fid}`;
                    ...
                    yield saveBuffer(FileName, stream).then(() => Filter_Media_1.default.VFmedia(client, Fox, AʀƈȶɨӼ, FileName, ConvertedName, `-af "aresample=48000,asetrate=48000*1.25"`));
                });
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                if (AʀƈȶɨӼ.isReplyAudio) {
                    ...
                    return FoxNeeded_1.default.VFox(client, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _reply to any audio in the chat_`, dotScrpt);
                }
            }
            catch (error) {
