...
Ѷ𝖑𝐤𝐲𝖗𝖊.chatID,
{
contextInfo: { mentionedJid: [Ѷ𝖑𝐤𝐲𝖗𝖊.sender, repliedPerson] },
image: { url: "./Ѷ𝖑𝐤𝐲𝖗𝖊👗𝕯𝖗𝖊𝖘𝖘/Ѷ𝖑𝐤𝐲𝖗𝖊_Matte.png" },
caption: `╔══『 𝐏𝐫𝐨𝐟𝐢𝐥𝐞𝐫® 』
║ *❣️ɴᴀᴍᴇ:* ${Ѷ𝖑𝐤𝐲𝖗𝖊.pushName || "No_Name"}
...
*🔒𝐒𝐭𝐚𝐭𝐮𝐬:* ${Ѷ𝖑𝐤𝐲𝖗𝖊.groupMetadata.subject} Group Has Been Banned!`,
footer: "*⦓ ⒸѶ𝖑𝐤𝐲𝖗𝖊 ⦔*",
buttons: [
{
buttonId: prefix + "help",
...
A𝖗𝖌𝖘,
"./Ѷ𝖑𝐤𝐲𝖗𝖊👗𝕯𝖗𝖊𝖘𝖘/Ѷ𝖑𝐤𝐲𝖗𝖊_Matte.png",
`*❌𝗘𝗿𝗿𝗼𝗿:* ${Ѷ𝖑𝐤𝐲𝖗𝖊.groupMetadata.subject} is Already Banned!`
);
}
}
);
