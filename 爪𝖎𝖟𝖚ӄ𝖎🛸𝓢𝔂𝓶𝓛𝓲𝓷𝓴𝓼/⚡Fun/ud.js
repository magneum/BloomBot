...
module.exports = {
  ...
  爪𝖎𝖟𝖚ӄ𝖎6ʍօʀɛ: `Use this command to find the meaning of a word in Urban Dictionary. Enter  *${ᴋᴇɪ}ud*  command.`,
...
*${ᴋᴇɪ}ud <text>`,
        ...
        let msg =
          ...
          result.thumbs_down;
        await 𝓚𝓻𝓪𝓴𝓲𝓷𝔃
          .sendMessage(爪𝖎𝖟𝖚ӄ𝖎6.chatId, msg, MessageType.text)
          .catch((error) => ℓιєηт.catch(error, 𝓚𝓻𝓪𝓴𝓲𝓷𝔃, 爪𝖎𝖟𝖚ӄ𝖎6));
      } catch (cᴇʀʀᴏʀ) {
        𝓚𝓻𝓪𝓴𝓲𝓷𝔃.sendMessage(
          爪𝖎𝖟𝖚ӄ𝖎6.chatId,
