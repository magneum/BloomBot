        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic_`, dotScrpt);
                }
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                if (!ǟʀɢʊʍɛռȶ) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic_`, dotScrpt);
                ...
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                let res = yield fetch(global.API("https://wall.alphacoders.com/api2.0", "/get.php", {
                ...
                if (!json) {
                    return Oops.VOp(TUF, Fox, AʀƈȶɨӼ, "❌𝐄𝐫𝐫𝐨𝐫꧂ Try Again Later!");
                }
                else {
                    img =
                        json.wallpapers[Math.floor(Math.random() * json.wallpapers.length)];
                }
                return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🍍𝐖𝐢𝐝𝐭𝐡: ${img.width || "undefined"}
🥝𝐇𝐞𝐢𝐠𝐡𝐭: ${img.height || "undefined"}
🎹 𝗙𝗶𝗹𝘁𝗲𝗿 𝗧𝘆𝗽𝗲: ${img.file_type || "undefined"}
🫖 𝗙𝗶𝗹𝗲𝘀𝗶𝘇𝗲: ${img.file_size || "undefined"}`, img.url_image);
            }
            catch (error) {
