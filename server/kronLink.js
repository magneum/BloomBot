...
module.exports = async (νℓкуяє, vcнaт, update, store) => {
  ...
  νℓкуяє.LinkList = require("../mongodb/antilink");
  νℓкуяє.Ranker = require("../mongodb/autorank");
  νℓкуяє.Bagde = require("../mongodb/badge");
  νℓкуяє.vimium = require("../mongodb/vimium");
  νℓкуяє.userBanCheck = require("../mongodb/ban");
  νℓкуяє.Cooldown = require("../mongodb/cooldown");
  νℓкуяє.DebugMode = require("../mongodb/debug");
  νℓкуяє.Economy = require("../mongodb/economy");
  νℓкуяє.Gamble = require("../mongodb/gamble");
  νℓкуяє.Halt = require("../mongodb/halt");
  νℓкуяє.nsfwCheck = require("../mongodb/nsfw");
  νℓкуяє.Pokemon = require("../mongodb/pokemon");
  νℓкуяє.UserPrivate = require("../mongodb/private");
  νℓкуяє.Robbery = require("../mongodb/robbery");
  νℓкуяє.ServerDB = require("../mongodb/ServerDB");
