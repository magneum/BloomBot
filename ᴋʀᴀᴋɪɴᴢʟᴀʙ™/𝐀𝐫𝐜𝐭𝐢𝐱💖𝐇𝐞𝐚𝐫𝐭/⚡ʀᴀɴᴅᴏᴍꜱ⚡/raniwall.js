        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!Image || Image === undefined || Image === null) {
                    return Oops.VOp(client, Fox, AʀƈȶɨӼ, "🛸Server couldn't generate images!");
                }
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                return Image_Button_1.default.VImg(client, Fox, AʀƈȶɨӼ, `💡 𝐓𝐢𝐭𝐥𝐞: _Random Anime Wallpaper_`, Image);
            }
            catch (error) {
