...
module.exports = async (BloomBot, mags, update, store) => {
  ...
  require("./pkglink")(BloomBot, mags, update, store);
  if (BloomBot.BLOOM_MODE == "group") {
    return require("@/app//Group")(BloomBot, mags, update, store);
  } else if (BloomBot.BLOOM_MODE == "private") {
    return require("@/app//Private")(BloomBot, mags, update, store);
  } else return require("@/app//Default")(BloomBot, mags, update, store);
};
