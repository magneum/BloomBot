...
}' -pix_fmt yuv420p -c:v libx264 -movflags +faststart -filter:v crop='floor(in_w/2)*2:floor(in_h/2)*2' './Cortana☕Shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4'`,
async (Error) => {
if (Error) {
userBadge.Limits = userBadge.Limits + 1;
await userBadge
...
`|⬡════════════════════════════════════════════|  ™𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛🛸𝐂𝐨𝐫𝐭𝐚𝐧𝐚𝐀𝐈(𝐜) |════════════════════════════════════════════⬡|`;
var PokeInfo = `𝐇𝐚𝐥𝐨🤖𝐔𝐬𝐞𝐫: @${աɦօֆɛռȶɦǟȶռʊʍ},
...
ƈօʀȶǟռǟ.chatId,
fs.readFileSync(
`./Cortana☕Shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4`
),
MessageType.video,
{
mimetype: `video/gif`,
