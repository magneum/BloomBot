...
exports.goodnight = async (
  ...
  let ꜰɪɴᴀʟʟɪɴᴋ;
  let ᴀɴɪᴍᴇʟɪɴᴋ = await ᴀɴɪᴍᴇ.goodnight();
  let ɢᴏᴛꜰɪʟᴇ = `./•Ext/${Vlkyre.key.id}}.gif`;
  let ɢɪᴠᴇꜰɪʟᴇ = `./•Ext/${Vlkyre.key.id}}.mp4`;
  if (!ᴀɴɪᴍᴇʟɪɴᴋ.endsWith(".gif") && !ᴀɴɪᴍᴇʟɪɴᴋ.endsWith(".mp4")) {
    ꜰɪɴᴀʟʟɪɴᴋ = await ᴀɴɪᴍᴇ2.goodnight();
  } else {
    ꜰɪɴᴀʟʟɪɴᴋ = ᴀɴɪᴍᴇʟɪɴᴋ;
  }
  ("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
  let dl𝐀𝐩𝐢 = new DownloaderHelper(ꜰɪɴᴀʟʟɪɴᴋ, "./•Ext", {
