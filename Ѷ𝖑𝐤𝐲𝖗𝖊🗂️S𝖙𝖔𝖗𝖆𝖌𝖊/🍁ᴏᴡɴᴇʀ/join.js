...
`|⬡════════════════════════════════════════════════════════════════════「  𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®  」═══════════════════════════════════════════════════════════════════⬡|`;
if (!F𝖚𝖑𝖑_A𝖗𝖌𝖘) return Ѷ𝖑𝐤𝐲𝖗𝖊.reply(`🔍 Please provide the group link`);
if (!isUrl(F𝖚𝖑𝖑_A𝖗𝖌𝖘) && !F𝖚𝖑𝖑_A𝖗𝖌𝖘.includes(`whatsapp.com`))
return Ѷ𝖑𝐤𝐲𝖗𝖊.reply(`🔍 Please provide the group link`);
Ѷ𝖑𝐤𝐲𝖗𝖊.reply(`wait your request is under process`);
let result = A𝖗𝖌𝖘[0].split(`https://chatID.whatsapp.com/`)[1];
await ӄ𝖗𝖞ӄ𝖓𝖟
.groupAcceptInvite(result)
.then((res) => Ѷ𝖑𝐤𝐲𝖗𝖊.reply(jsonformat(res)))
.catch((err) => Ѷ𝖑𝐤𝐲𝖗𝖊.reply(`Invalid 📘 *URL: ${q}*`));
};
`|⬡════════════════════════════════════════════════════════════|▷   ᴘᴏᴡᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™  ◁|════════════════════════════════════════════════════════════⬡|`;
