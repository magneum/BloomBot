...
let MeD = [];
let MeE = [];
let ʀᴇꜱᴘᴏɴꜱᴇ1 = await ᴋᴜɴᴀɪ.groupInviteCode("120363020792949649@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇ2 = await ᴋᴜɴᴀɪ.groupInviteCode("120363039223842047@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇ3 = await ᴋᴜɴᴀɪ.groupInviteCode("120363024871653603@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇ4 = await ᴋᴜɴᴀɪ.groupInviteCode("120363042762307739@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇ5 = await ᴋᴜɴᴀɪ.groupInviteCode("120363022161584857@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇA = await ᴋᴜɴᴀɪ.groupMetadata("120363020792949649@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇB = await ᴋᴜɴᴀɪ.groupMetadata("120363039223842047@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇC = await ᴋᴜɴᴀɪ.groupMetadata("120363024871653603@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇD = await ᴋᴜɴᴀɪ.groupMetadata("120363042762307739@g.us");
let ʀᴇꜱᴘᴏɴꜱᴇE = await ᴋᴜɴᴀɪ.groupMetadata("120363022161584857@g.us");
...
ꜱᴇʀᴄ.LastTime = Date.now();
await ꜱᴇʀᴄ.save().catch((𝕰𝖗𝖗𝖔𝖗) => Caught(ᴋᴜɴᴀɪ, Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊, 𝕰𝖗𝖗𝖔𝖗));
return await 𝕮𝖆𝖘𝖊𝕮𝖎𝖗𝖈𝖚𝖎𝖙(Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊, ᴋᴜɴᴀɪ, 𝕮𝖔𝖚𝖓𝖙𝖊𝖗𝖀𝖘𝖊𝖗, Ѷ𝖎𝖔𝖓);
}
}
}
);
