...
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷◁|═════════════════════════════════════════════════════════════════════⬡|");
let usep = Ѷ𝖑𝐤𝐲𝖗𝖊.sender;
let recp = ``;
try {
users = Ѷ𝖑𝐤𝐲𝖗𝖊.mentionedJid[0]
? Ѷ𝖑𝐤𝐲𝖗𝖊.mentionedJid[0]
: Ѷ𝖑𝐤𝐲𝖗𝖊.quoted
? Ѷ𝖑𝐤𝐲𝖗𝖊.quoted.sender
: text.replace(/[^0-9]/g, ``) + `@s.whatsapp.net`;

ment = [usep, users];
} catch {
users = `none`;
ment = [usep, Ѷ𝖑𝐤𝐲𝖗𝖊.sender];
}
if (users == `none`) {
recp = `@${Ѷ𝖑𝐤𝐲𝖗𝖊.sender.split(`@`)[0]} x  themselves`;
console.log(recp);
} else {
let rcpp = `@${users.split(`@`[0])}`;
recp = `@${Ѷ𝖑𝐤𝐲𝖗𝖊.sender.split(`@`)[0]} x  @${users.split(`@`)[0]}`;
...
caption += `${jj}`;
try {
ppuser = await ӄ𝖗𝖞ӄ𝖓𝖟.profilePictureUrl(Ѷ𝖑𝐤𝐲𝖗𝖊.sender, `image`);
} catch {
ppuser = `./Ѷ𝖑𝐤𝐲𝖗𝖊👗𝕯𝖗𝖊𝖘𝖘/Ѷ𝖑𝐤𝐲𝖗𝖊.png`;
}
if (users == `none`) {
try {
ppuser2 = await ӄ𝖗𝖞ӄ𝖓𝖟.profilePictureUrl(Ѷ𝖑𝐤𝐲𝖗𝖊.sender, `image`);
} catch {
ppuser = `./Ѷ𝖑𝐤𝐲𝖗𝖊👗𝕯𝖗𝖊𝖘𝖘/Ѷ𝖑𝐤𝐲𝖗𝖊.png`;
}
} else {
...
return await Image_Button(ӄ𝖗𝖞ӄ𝖓𝖟, Ѷ𝖑𝐤𝐲𝖗𝖊, A𝖗𝖌𝖘, ship, caption);
};
("|⬡════════════════════════════════════════════════════════════════════════════════════|▷ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ◁|═════════════════════════════════════════════════════════════════════⬡|");
