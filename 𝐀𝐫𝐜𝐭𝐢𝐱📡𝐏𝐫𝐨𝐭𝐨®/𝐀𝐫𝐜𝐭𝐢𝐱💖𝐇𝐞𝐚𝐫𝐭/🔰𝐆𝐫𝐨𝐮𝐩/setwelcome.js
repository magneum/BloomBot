                ...
                */
                ...
                yield Welcome.findOne({
                    ...
                    */
                    if (ǟʀɢʊʍɛռȶ[0] === `on`) {
                        if (!ǟʀɢʊʍɛռȶ[1]) {
                            return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _custom welcome message_`, dotScrpt);
                        }
                        /*
                        ⦓════════════════════════════════════════════| ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════⦔
                        「   𝐀𝐫𝐜𝐭𝐢𝐱 𝐀𝐩𝐢®   」                                                                            「   𝐀𝐫𝐜𝐭𝐢𝐱 𝐀𝐩𝐢®   」
                        ...
                        */
                        if (!userWel) {
                            ...
                            return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🥞 𝐖𝐞𝐥𝐜𝐨𝐦𝐞𝐫
...
${WelcomeNote}`, 𝕻𝕻𝖑𝖊𝖙𝖊𝖗);
                        ...
                        */
                        ...
                        return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _custom welcome message_
