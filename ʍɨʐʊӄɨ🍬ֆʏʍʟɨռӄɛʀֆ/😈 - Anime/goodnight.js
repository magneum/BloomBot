...
🤧𝐎𝐩𝐩𝐬𝐢𝐞!𝘎𝘪𝘧 𝘕𝘰𝘵 𝘍𝘰𝘶𝘯𝘥.𝘛𝘳𝘺 𝘈𝘨𝘢𝘪𝘯!`
          );
        } catch (ℓαвєяяσя) {
...
└───────◆➤`,
              ...
              .then(
                fs.unlinkSync(`./ʍɨʐʊӄɨ🗑️ȶɛʍք/${Ping}_${FinalName}.mp4`),
                fs.unlinkSync(`./ʍɨʐʊӄɨ🗑️ȶɛʍք/${Ping}_${FinalName}.gif`)
              )
