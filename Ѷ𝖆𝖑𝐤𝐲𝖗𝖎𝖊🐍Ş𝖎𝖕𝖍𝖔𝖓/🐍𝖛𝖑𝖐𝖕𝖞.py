...
try :#line:48
    subprocess .run (["node","Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊🎒𝕭𝖆𝖌/Krank.js"],check =True ,stdout =subprocess .PIPE ).stdout #line:49
...
try :#line:67
    ...
    subprocess .run (["git","init","--initial-branch=🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:71
    subprocess .run (["git","fetch","origin","🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:72
    subprocess .run (["git","reset","--hard","origin/🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:73
    ...
    try :#line:87
        ...
        subprocess .run (["git","init","--initial-branch=🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:91
        subprocess .run (["git","fetch","origin","🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:92
        subprocess .run (["git","reset","--hard","origin/🐍Ş𝖎𝖕𝖍𝖔𝖓®"],check =True ,stdout =subprocess .PIPE ).stdout #line:93
