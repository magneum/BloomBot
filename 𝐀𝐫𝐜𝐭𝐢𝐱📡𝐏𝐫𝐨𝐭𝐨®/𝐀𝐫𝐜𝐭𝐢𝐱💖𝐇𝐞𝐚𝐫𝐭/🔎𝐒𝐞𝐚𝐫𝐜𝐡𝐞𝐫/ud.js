    ...
    handle(TUF, Fox, AʀƈȶɨӼ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let Response = yield ud.define(text);
                ...
                result.example = result.example.replace(/\]/g, `_`);
                return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `𝐔𝐫𝐛𝐚𝐧📙𝐃𝐢𝐜𝐭𝐢𝐨𝐧𝐚𝐫𝐲
🔎Word: ${result.word}
📚Defination: ${result.definition}
🫒Example: ${result.example}
👍: ${result.thumbs_up} |👎: ${result.thumbs_down}`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Blue_Grey.png");
            }
            catch (error) {
