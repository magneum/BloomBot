    ...
    handle(TUF, Fox, Vʟӄʏʀɛ, ǟʀɢʊʍɛռȶ, ӄ𝖗𝖞ӄ𝖓𝖟) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield Image_Button_1.default.VImg(TUF, Fox, Vʟӄʏʀɛ, `💡𝐈𝐧𝐟𝐨: Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 is now rebootig itself and it's servers..`, "./𝐕𝐥𝐤𝐲𝐫𝐞👜𝐁𝐚𝐠/Vʟӄʏʀɛ.png");
                yield Heroku.delete(`/apps/${______1.default.Heroku_App}/dynos/worker`).catch((error) => Oops_1.default.VOp(TUF, Fox, Vʟӄʏʀɛ, error));
                // ⦓═════════════════════════════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═══════════ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ═══════════「 𝐕𝐥𝐤𝐲𝐫𝐞 𝐀𝐩𝐢®」═════════════════════════════════⦔
            }
            catch (error) {
