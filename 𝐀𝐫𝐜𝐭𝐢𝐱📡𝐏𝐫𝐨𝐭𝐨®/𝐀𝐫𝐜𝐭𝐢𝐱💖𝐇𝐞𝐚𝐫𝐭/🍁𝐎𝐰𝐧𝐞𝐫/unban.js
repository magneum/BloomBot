...
const Ban = require(`../../𝐀𝐫𝐜𝐭𝐢𝐱✈️𝐂𝐨𝐧𝐧𝐞𝐜𝐭/🍃mongo/ban`);
//" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (AʀƈȶɨӼ.isTextReply) {
                    ...
                    if (Receiver === ʟɴᴀᴍᴇ) {
                        return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `❌𝐃𝐞𝐧𝐢𝐞𝐝: _Can't Kick Bot Owner!_`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Error.png");
                    }
                }
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                if (!AʀƈȶɨӼ.fromMe && !AʀƈȶɨӼ.isSenderTUFs) {
                    return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `❌𝐃𝐞𝐧𝐢𝐞𝐝: _Owner/Dev Only.You Are Not Allowed!_`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Orange.png");
                }
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                if (AʀƈȶɨӼ.isGroup && !AʀƈȶɨӼ.isTextReply) {
                    ...
                    yield Ban.findOne({
                        ...
                        if (error) {
                            Oops_1.default.VOp(TUF, Fox, AʀƈȶɨӼ, error);
                            return;
                        }
                        if (!userBan) {
                            return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${groupData.subject}* Was Not Banned!`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Black_Gold.png");
                        }
                        else {
                            yield userBan
                                .delete()
                                .catch((error) => Oops_1.default.VOp(TUF, Fox, AʀƈȶɨӼ, error));
                            return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${groupData.subject}* Has Been Un-Banned!`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Black_Gold.png");
                        }
                    }));
                    //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                }
                else if (AʀƈȶɨӼ.isGroup && AʀƈȶɨӼ.isTextReply) {
                    Ban.findOne({
                        ID: Receiver,
                    }, (error, userBan) => __awaiter(this, void 0, void 0, function* () {
                        if (error) {
                        ...
                        if (!userBan) {
                            return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${քɛʀֆօռɢօȶռʊʍ}* Was Not Banned!`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Black_Gold.png");
                        }
                        else {
                            yield userBan
                                .delete()
                                .catch((error) => Oops_1.default.VOp(TUF, Fox, AʀƈȶɨӼ, error));
                            return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `🛡️𝐒𝐮𝐝𝐨 𝐔𝐧𝐁𝐚𝐧: *${քɛʀֆօռɢօȶռʊʍ}* Has Been Un-Banned!`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Black_Gold.png");
                        }
                    }));
                    //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                }
                else {
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - _reply to person to un-ban_: ${______1.default.MuveOn}${dotScrpt.toUpperCase()}
