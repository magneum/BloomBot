...
RUN npm install n -g && n install 18 && hash -r && npm install yarn -g
...
RUN yarn install --force rm yarn-lock.json && pip install -r ⭕𝖈𝖆𝖗𝖆.txt && yarn global add spotify-dl spdl-core
