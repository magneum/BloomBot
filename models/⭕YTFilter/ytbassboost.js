...
*⭕Filter:* ${pfname}
*🍻Title:* ${mData._youtube_search[0].title || "null"}
*🙈Views:* ${mData._youtube_search[0].views || "null"}
*⏰Duration:* ${mData._youtube_search[0].timestamp || "null"} | ${
            mData._youtube_search[0].ago || "null"
          }
*🔗Link:* ${mData._youtube_search[0].url || "null"}
*🖊️Author:* ${mData._youtube_search[0].author.name || "null"}


*📜Description:*
${mData._youtube_search[0].description || "null"}`,
