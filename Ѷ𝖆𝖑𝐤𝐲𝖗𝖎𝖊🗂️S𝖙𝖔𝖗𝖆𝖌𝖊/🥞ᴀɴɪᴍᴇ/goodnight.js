...
exports.goodnight = async (
  ...
  try {
    ...
    `|⬡════════════════════════════════════════════════════════════════════「  𝐕𝐚𝐥𝐤𝐲𝐫𝐢𝐞 𝐀𝐩𝐢®  」═══════════════════════════════════════════════════════════════════⬡|`;
    let ꜰɪɴᴀʟʟɪɴᴋ;
    var ᴀɴɪᴍᴇʟɪɴᴋ = await ᴀɴɪᴍᴇ.goodnight();
    const ɢᴏᴛꜰɪʟᴇ = `./${Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.key.id}${Date.now().toString()}.gif`;
    const ɢɪᴠᴇꜰɪʟᴇ = `./${Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊.key.id}${Date.now().toString()}.mp4`;
...
╚═══════╝`,
    ...
    return fs.unlinkSync(ɢɪᴠᴇꜰɪʟᴇ, ɢᴏᴛꜰɪʟᴇ);
  } catch (𝕰𝖗𝖗𝖔𝖗) {
    return await Caught(ӄ𝖚𝖓𝖆𝖎, Ѷ𝖆𝖑𝐤𝐲𝖗𝖎𝖊, 𝕰𝖗𝖗𝖔𝖗);
  }
};
