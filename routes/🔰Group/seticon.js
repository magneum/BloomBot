...
*⚡Usage* 
> _${ѕуηтнσяiα.prefix}${pfname} reply/send image_`
      );
    }
    if (/webp/.test(ѕуηтнσяiα.mime)) {
      await ѕуηтнσяiα.sendMessage(νℓкhat.chat, {
        react: {
          text: "❌",
          key: νℓкhat.key,
...
> _${ѕуηтнσяiα.prefix}${pfname} reply/send image_`
    ...
    let media = await ѕуηтнσяiα.downloadAndSaveMediaMessage(ѕуηтнσяiα.quoted);
    await ѕуηтнσяiα
