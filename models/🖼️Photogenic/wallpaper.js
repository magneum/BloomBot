...
> _${WhatsBot.prefix}${finalname} manga-name_`
    ...
    var wall = new WhatsBot.AnimeWallpaper();
    var wallpaper = await wall.getAnimeWall4({
      title: WhatsBot.args.join(" "),
=======
> _${voxbot.prefix}${finalname} manga-name_`
      );
    }

    var wall = new voxbot.AnimeWallpaper();
    var wallpaper = await wall.getAnimeWall4({
      title: voxbot.args.join(" "),
>>>>>>> 17f52fe472c04e519779246ebe3026ed85ef536a
      type: "sfw",
      page: [1, 2, 3, 4],
    });
...
*❌Error* 
> Couldn't find any results on ${WhatsBot.args.join(" ")}_`
      );
    }
...
*❌Error* 
> Couldn't find any results on ${voxbot.args.join(" ")}_`
      );
    }
