...
let Bagde = require("../•dBase/🍃𝖒𝖔𝖓𝖌𝖔/badge");
let { simpleGit, CleanOptions } = require("simple-git");
let Ranker = require("../•dBase/🍃𝖒𝖔𝖓𝖌𝖔/autorank");
let ClaimSchema = require("../•dBase/🍃𝖒𝖔𝖓𝖌𝖔/Claim");
let LinkList = require("../•dBase/🍃𝖒𝖔𝖓𝖌𝖔/antilink");
let { Image_Button } = require("../•Buttons/Image_Button");
let usedUser = require("../•dBase/𝖀𝖘𝖊𝖗🍣𝖒𝖔𝖓𝖌𝖔/usedUser");
let userBanCheck = require("../•dBase/𝖀𝖘𝖊𝖗🍣𝖒𝖔𝖓𝖌𝖔/user");
let userExhaust = require("../•dBase/𝖀𝖘𝖊𝖗🍣𝖒𝖔𝖓𝖌𝖔/userExhaust");
let { PokeList } = require("../•Modules/pokelist");
...
// )
// );
require("child_process").exec("ctrl+c");
}
} catch (ᴇʀ) {
