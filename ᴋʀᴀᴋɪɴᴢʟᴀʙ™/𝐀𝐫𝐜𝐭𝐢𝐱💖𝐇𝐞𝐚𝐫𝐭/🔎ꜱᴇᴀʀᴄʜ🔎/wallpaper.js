...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic name_`,
                                    },
                                ],
                            },
                        ],
...
Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _topic name_`,
                ...
                if (!json) {
                    return Oops.VOp(client, Fox, AʀƈȶɨӼ, "❌𝐄𝐫𝐫𝐨𝐫꧂ Try Again Later!");
                }
                else {
                    img =
                        json.wallpapers[Math.floor(Math.random() * json.wallpapers.length)];
                }
                return Image_Button.VImg(client, Fox, AʀƈȶɨӼ, `🍍𝐖𝐢𝐝𝐭𝐡: ${img.width || "undefined"}
