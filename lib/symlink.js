...
module.exports = async (BloomBot, mags, update, store) => {
  ...
  if (BloomBot.bloom_mode == "group") {
    return require("@/client/mode/Group")(BloomBot, mags, update, store);
  } else if (BloomBot.bloom_mode == "private") {
    return require("@/client/mode/Private")(BloomBot, mags, update, store);
  } else return require("@/client/mode/Default")(BloomBot, mags, update, store);
};
