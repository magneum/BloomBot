...
module.exports = {
name: `lock`,
description: `lock non-admin members of a group.`,
...
return await Mizuki_Buttons.MTB(
ӄʀǟӄɨռʐ,
chat,
𝓜𝖎𝖟𝖚ӄ𝖎,
...
.sendMessage(
𝓜𝖎𝖟𝖚ӄ𝖎.chatId,
`*${ᴋᴇɪ}lock*  command is only applicable in a group chat.`,
MessageType.text,
{ quoted: chat }
)
.catch((ℓαвєяяσя) => ꜰᴜᴄᴋ.catch(ℓαвєяяσя, ӄʀǟӄɨռʐ, 𝓜𝖎𝖟𝖚ӄ𝖎, chat));
