        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (ǟʀɢʊʍɛռȶ.length === 0) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _anime name_`, dotScrpt);
                }
                //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                if (!ǟʀɢʊʍɛռȶ) {
                    return FoxNeeded_1.default.VFox(TUF, Fox, AʀƈȶɨӼ, `Option 1 - ${______1.default.MuveOn}${dotScrpt.toUpperCase()} _anime name_`, dotScrpt);
                ...
                yield malScraper.getInfoFromName(name).then((data) => __awaiter(this, void 0, void 0, function* () {
                    return Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `💡 𝐓𝐢𝐭𝐥𝐞: *${data.title}*
...
🎯 𝗜𝗱: _${data.id}_
📥 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱: _${data.url}_`, data.picture);
                }));
            }
            catch (error) {
