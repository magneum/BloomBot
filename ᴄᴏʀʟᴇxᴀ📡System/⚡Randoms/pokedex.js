...
module.exports = {
name: newScpt,
𝖈𝖔𝖗𝖑𝖊𝖝𝖆ӄǟɨʐօ: `*${ᴋᴇɪ}pokedex* _pokemon-name_`,
...
}' -pix_fmt yuv420p -c:v libx264 -movflags +faststart -filter:v crop='floor(in_w/2)*2:floor(in_h/2)*2' './ᴄᴏʀʟᴇxᴀ☕Shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4'`,
async (Error) => {
if (Error) {
userBadge.Limits = userBadge.Limits + 1;
await userBadge
...
𝖈𝖔𝖗𝖑𝖊𝖝𝖆.chatId,
fs.readFileSync(
`./ᴄᴏʀʟᴇxᴀ☕Shop/${աɦօֆɛռȶɦǟȶռʊʍ.toString()}.mp4`
),
MessageType.video,
{
mimetype: `video/gif`,
quoted: chat,
caption: `◤Ⓒ𝐂𝐨𝐫𝐥𝐞𝐱𝐚 • 𝐊𝐫𝐚𝐤𝐢𝐧𝐳𝐋𝐚𝐛™ • 𝟐𝟎𝟐𝟐◥n\n` + PokeInfo,
