...
module.exports = {
  name: newScpt,
  ᴠʟᴋʏʀᴇӄǟɨʐօ: `${ᴋᴇɪ}debug _on/off_`,
...
🔗𝐃𝐞𝐛𝐮𝐠: ✅On
🌱𝗕𝘂𝘁𝘁𝗼𝗻𝘀 𝗧𝗼 𝗧𝗼𝗴𝗴𝗹𝗲 𝐃𝐞𝐛𝐮𝐠 𝐌𝐨𝐝𝐞👇🏽‍`,
                      footerText: `⦓ 𝐕𝐥𝐤𝐲𝐫𝐞 ⦔\nⒸ2022 ᴋʀᴀᴋɪɴᴢʟᴀʙ™`,
                      buttons: [
                        {
                          buttonId: `${ᴋᴇɪ}debug on`,
                          buttonText: { displayText: `${ᴋᴇɪ}debug on` },
                          type: 1,
                        },
                        {
                          buttonId: `${ᴋᴇɪ}debug off`,
                          buttonText: { displayText: `${ᴋᴇɪ}debug off` },
                          type: 1,
                        },
                      ],
                      headerType: 4,
