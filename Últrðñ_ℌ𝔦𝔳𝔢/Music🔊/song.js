...
module.exports = {
  ...
  ƈʏɮօʀɢʍօʀɛ: `Use this module to download audio of your choice either by specifying a YouTube link or the name of the song.`,
...
🎮𝗜𝘁 𝘄𝗮𝘀 𝗣𝗠? • ${Últrðñ.isPm}`,
      ...
      try {
        ...
        ffmpeg(stream)
          ...
          .on(`end`, async () => {
            await ӄʀǟӄɨռʐ
              .sendMessage(Últrðñ.chatId, `Uploading song...`, MessageType.text)
              .catch((cᴇʀʀᴏʀ) =>
                ӄʀǟӄɨռʐ.sendMessage(
                  Últrðñ.chatId,
                  `ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ.ʜᴇʀᴇ ᴀʀᴇ ꜱᴏᴍᴇ ʟᴏɢꜱ ꜱɪɴᴄᴇ ᴡʜᴇɴ ᴛʜᴇ ʙᴏᴛ ᴡᴀꜱ ɴᴏᴛ ʀᴇꜱᴘᴏɴᴅɪɴɢ ᴀꜱ ᴇxᴘᴇᴄᴛᴇᴅ.
