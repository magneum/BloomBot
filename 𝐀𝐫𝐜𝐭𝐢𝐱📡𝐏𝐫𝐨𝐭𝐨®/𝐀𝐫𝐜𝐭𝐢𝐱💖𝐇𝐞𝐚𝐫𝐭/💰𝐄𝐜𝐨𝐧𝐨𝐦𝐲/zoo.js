...
┊    𝐙𝐨𝐨🐆𝐎𝐰𝐧𝐞𝐫
╚◇══════════════◇╝
💡𝐈𝐧𝐟𝐨: _Just Bought A Zoo!_`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Night_Forest.png");
                        //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                    }
                    else {
                        Zoology.findOne({
                            ID: ʟɴᴀᴍᴇ,
                        }, (error, userZoo) => __awaiter(this, void 0, void 0, function* () {
                            if (error)
                                return Oops_1.default.VOp(TUF, Fox, AʀƈȶɨӼ, error);
                            if (!userZoo) {
...
🌿𝗡𝗮𝗺𝗲: _Amature Zoo Keeper!_`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Night_Forest.png");
                            }
                            else {
                                if (userZoo.zootimeout - (Date.now() - userZoo.zoodone) > 0) {
                                    let time = ms(userZoo.zootimeout - (Date.now() - userZoo.zoodone));
                                    return yield Image_Button_1.default.VImg(TUF, Fox, AʀƈȶɨӼ, `
╔◇══════════════◇╗
┊    𝐙𝐨𝐨🐆𝐎𝐰𝐧𝐞𝐫
╚◇══════════════◇╝
❌𝗘𝗿𝗿𝗼𝗿: You've Recently Bought a New Animal. 
🐓𝗭𝗼𝗼_𝗔𝗴𝗮𝗶𝗻: ${time.minutes}m ${time.seconds}s`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Orange.png");
                                    //" |════════════════════════════════════════════| Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ |═══════════════════════════════════════════| "
                                }
                                else {
                                    ...
                                    const worth = Math.floor(Math.random() * (anim.max - anim.min + 1)) +
                                        anim.min;
...
💍𝗜𝘁𝗲𝗺 𝗥𝗮𝗿𝗶𝘁𝘆: _${rarity}_`, "./𝐀𝐫𝐜𝐭𝐢𝐱👜𝐁𝐚𝐠/AʀƈȶɨӼ_Noen_Forest.jpg");
                                }
                            }
                        }));
                    }
