...
chat,
ᴠʟᴋʏʀᴇ,
`❣️ 𝗠𝗲𝗻𝘁𝗶𝗼𝗻:  ꧁◤ *@${ᴘɴᴀᴍᴇ}* ◢꧂ _This Command is Only For Groups!_!`
);
}
if (ᴠʟᴋʏʀᴇ.fromMe) {
return ᴠʟᴋʏʀᴇ_Buttons.MTB(
...
chat,
ᴠʟᴋʏʀᴇ,
`❣️ 𝗠𝗲𝗻𝘁𝗶𝗼𝗻:  ꧁◤ *@${ᴘɴᴀᴍᴇ}* ◢꧂ _This Command is Only For Members and Not You ᴠʟᴋʏʀᴇ-User-Bots!_!`
);
}
`|⬡════════════════════════════════════════════|⌜ Ⓒ𝐕𝐥𝐤𝐲𝐫𝐞 ⌬ ❝ ᴘᴏᴡᴇʀᴇᴅ ☊ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞ ⌟|═══════════════════════════════════════════⬡|`;
Usersᴠʟᴋʏʀᴇ.findOne(
