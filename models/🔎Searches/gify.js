...
*⚡Usage* 
<<<<<<< HEAD
> _${WhatsBot.prefix}${finalname} gif-name_`
=======
> _${voxbot.prefix}${finalname} gif-name_`
>>>>>>> 17f52fe472c04e519779246ebe3026ed85ef536a
      );
    }
...
=======
      let { data: gi } = await voxbot.axios.get(
        `https://g.tenor.com/v1/search?q=${voxbot.args.join(
          " "
        )}&key=LIVDSRZULELA&limit=8`
      );
