...
("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
const ToSticker = (client, Fox, ǟʀɢʊʍɛռȶ, AʀƈȶɨӼ, FileID, FileSocket) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (AʀƈȶɨӼ.type === "image" || AʀƈȶɨӼ.isReplyImage) {
            (0, fluent_ffmpeg_1.default)(FileName)
                ...
                ("|⬡════════════════════════════════════════════|❝ Ⓒ𝐀𝐫𝐜𝐭𝐢𝐱 ☊ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴋʀᴀᴋɪɴᴢʟᴀʙ™ ❞|═══════════════════════════════════════════⬡|");
                if (!ǟʀɢʊʍɛռȶ) {
                    yield client.sendMessage(AʀƈȶɨӼ.chatId, `💡𝐈𝐧𝐟𝐨: No Sticker Title Provided.
...
*Sticker Category:* ᴋʀᴀᴋɪɴᴢʟᴀʙ™`, message_type_1.MessageType.text, {
                    ...
                    yield client
                        .sendMessage(AʀƈȶɨӼ.chatId, ᴋʀᴀᴋɪɴᴢʟᴀʙ, message_type_1.MessageType.sticker)
